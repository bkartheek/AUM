...
`}strong({tokens:e}){return`<strong>${this.parser.parseInline(e)}</strong>`}em({tokens:e}){return`<em>${this.parser.parseInline(e)}</em>`}codespan({text:e}){return`<code>${ot(e,!0)}</code>`}br(e){return`<br>`}del({tokens:e}){return`<del>${this.parser.parseInline(e)}</del>`}link({href:e,title:t,tokens:n}){let r=this.parser.parseInline(n),i=st(e);if(i===null)return r;e=i;let a=`<a href="`+e+`"`;return t&&(a+=` title="`+ot(t)+`"`),a+=`>`+r+`</a>`,a}image({href:e,title:t,text:n,tokens:r}){r&&(n=this.parser.parseInline(r,this.parser.textRenderer));let i=st(e);if(i===null)return ot(n);e=i;let a=`<img src="${e}" alt="${ot(n)}"`;return t&&(a+=` title="${ot(t)}"`),a+=`>`,a}text(e){return`tokens`in e&&e.tokens?this.parser.parseInline(e.tokens):`escaped`in e&&e.escaped?e.text:ot(e.text)}},gt=class{strong({text:e}){return e}em({text:e}){return e}codespan({text:e}){return e}del({text:e}){return e}html({text:e}){return e}text({text:e}){return e}link({text:e}){return``+e}image({text:e}){return``+e}br(){return``}checkbox({raw:e}){return e}},_t=class e{options;renderer;textRenderer;constructor(e){this.options=e||b,this.options.renderer=this.options.renderer||new ht,this.renderer=this.options.renderer,this.renderer.options=this.options,this.renderer.parser=this,this.textRenderer=new gt}static parse(t,n){return new e(n).parse(t)}static parseInline(t,n){return new e(n).parseInline(t)}parse(e){this.renderer.parser=this;let t=``;for(let n=0;n<e.length;n++){let r=e[n];if(this.options.extensions?.renderers?.[r.type]){let e=r,n=this.options.extensions.renderers[e.type].call({parser:this},e);if(n!==!1||![`space`,`hr`,`heading`,`code`,`table`,`blockquote`,`list`,`html`,`def`,`paragraph`,`text`].includes(e.type)){t+=n||``;continue}}let i=r;switch(i.type){case`space`:t+=this.renderer.space(i);break;case`hr`:t+=this.renderer.hr(i);break;case`heading`:t+=this.renderer.heading(i);break;case`code`:t+=this.renderer.code(i);break;case`table`:t+=this.renderer.table(i);break;case`blockquote`:t+=this.renderer.blockquote(i);break;case`list`:t+=this.renderer.list(i);break;case`checkbox`:t+=this.renderer.checkbox(i);break;case`html`:t+=this.renderer.html(i);break;case`def`:t+=this.renderer.def(i);break;case`paragraph`:t+=this.renderer.paragraph(i);break;case`text`:t+=this.renderer.text(i);break;default:{let e=`Token with "`+i.type+`" type was not found.`;if(this.options.silent)return console.error(e),``;throw Error(e)}}}return t}parseInline(e,t=this.renderer){this.renderer.parser=this;let n=``;for(let r=0;r<e.length;r++){let i=e[r];if(this.options.extensions?.renderers?.[i.type]){let e=this.options.extensions.renderers[i.type].call({parser:this},i);if(e!==!1||![`escape`,`html`,`link`,`image`,`strong`,`em`,`codespan`,`br`,`del`,`text`].includes(i.type)){n+=e||``;continue}}let a=i;switch(a.type){case`escape`:n+=t.text(a);break;case`html`:n+=t.html(a);break;case`link`:n+=t.link(a);break;case`image`:n+=t.image(a);break;case`checkbox`:n+=t.checkbox(a);break;case`strong`:n+=t.strong(a);break;case`em`:n+=t.em(a);break;case`codespan`:n+=t.codespan(a);break;case`br`:n+=t.br(a);break;case`del`:n+=t.del(a);break;case`text`:n+=t.text(a);break;default:{let e=`Token with "`+a.type+`" type was not found.`;if(this.options.silent)return console.error(e),``;throw Error(e)}}}return n}},vt=class{options;block;constructor(e){this.options=e||b}static passThroughHooks=new Set([`preprocess`,`postprocess`,`processAllTokens`,`emStrongMask`]);static passThroughHooksRespectAsync=new Set([`preprocess`,`postprocess`,`processAllTokens`]);preprocess(e){return e}postprocess(e){return e}processAllTokens(e){return e}emStrongMask(e){return e}provideLexer(e=this.block){return e?j.lex:j.lexInline}provideParser(e=this.block){return e?_t.parse:_t.parseInline}},yt=new class{defaults=y();options=this.setOptions;parse=this.parseMarkdown(!0);parseInline=this.parseMarkdown(!1);Parser=_t;Renderer=ht;TextRenderer=gt;Lexer=j;Tokenizer=A;Hooks=vt;constructor(...e){this.use(...e)}walkTokens(e,t){let n=[];for(let r of e)switch(n=n.concat(t.call(this,r)),r.type){case`table`:{let e=r;for(let r of e.header)n=n.concat(this.walkTokens(r.tokens,t));for(let r of e.rows)for(let e of r)n=n.concat(this.walkTokens(e.tokens,t));break}case`list`:{let e=r;n=n.concat(this.walkTokens(e.items,t));break}default:{let e=r;this.defaults.extensions?.childTokens?.[e.type]?this.defaults.extensions.childTokens[e.type].forEach(r=>{let i=e[r].flat(1/0);n=n.concat(this.walkTokens(i,t))}):e.tokens&&(n=n.concat(this.walkTokens(e.tokens,t)))}}return n}use(...e){let t=this.defaults.extensions||{renderers:{},childTokens:{}};return e.forEach(e=>{let n={...e};if(n.async=this.defaults.async||n.async||!1,e.extensions&&(e.extensions.forEach(e=>{if(!e.name)throw Error(`extension name required`);if(`renderer`in e){let n=t.renderers[e.name];n?t.renderers[e.name]=function(...t){let r=e.renderer.apply(this,t);return r===!1&&(r=n.apply(this,t)),r}:t.renderers[e.name]=e.renderer}if(`tokenizer`in e){if(!e.level||e.level!==`block`&&e.level!==`inline`)throw Error(`extension level must be 'block' or 'inline'`);let n=t[e.level];n?n.unshift(e.tokenizer):t[e.level]=[e.tokenizer],e.start&&(e.level===`block`?t.startBlock?t.startBlock.push(e.start):t.startBlock=[e.start]:e.level===`inline`&&(t.startInline?t.startInline.push(e.start):t.startInline=[e.start]))}`childTokens`in e&&e.childTokens&&(t.childTokens[e.name]=e.childTokens)}),n.extensions=t),e.renderer){let t=this.defaults.renderer||new ht(this.defaults);for(let n in e.renderer){if(!(n in t))throw Error(`renderer '${n}' does not exist`);if([`options`,`parser`].includes(n))continue;let r=n,i=e.renderer[r],a=t[r];t[r]=(...e)=>{let n=i.apply(t,e);return n===!1&&(n=a.apply(t,e)),n||``}}n.renderer=t}if(e.tokenizer){let t=this.defaults.tokenizer||new A(this.defaults);for(let n in e.tokenizer){if(!(n in t))throw Error(`tokenizer '${n}' does not exist`);if([`options`,`rules`,`lexer`].includes(n))continue;let r=n,i=e.tokenizer[r],a=t[r];t[r]=(...e)=>{let n=i.apply(t,e);return n===!1&&(n=a.apply(t,e)),n}}n.tokenizer=t}if(e.hooks){let t=this.defaults.hooks||new vt;for(let n in e.hooks){if(!(n in t))throw Error(`hook '${n}' does not exist`);if([`options`,`block`].includes(n))continue;let r=n,i=e.hooks[r],a=t[r];vt.passThroughHooks.has(n)?t[r]=e=>{if(this.defaults.async&&vt.passThroughHooksRespectAsync.has(n))return(async()=>{let n=await i.call(t,e);return a.call(t,n)})();let r=i.call(t,e);return a.call(t,r)}:t[r]=(...e)=>{if(this.defaults.async)return(async()=>{let n=await i.apply(t,e);return n===!1&&(n=await a.apply(t,e)),n})();let n=i.apply(t,e);return n===!1&&(n=a.apply(t,e)),n}}n.hooks=t}if(e.walkTokens){let t=this.defaults.walkTokens,r=e.walkTokens;n.walkTokens=function(e){let n=[];return n.push(r.call(this,e)),t&&(n=n.concat(t.call(this,e))),n}}this.defaults={...this.defaults,...n}}),this}setOptions(e){return this.defaults={...this.defaults,...e},this}lexer(e,t){return j.lex(e,t??this.defaults)}parser(e,t){return _t.parse(e,t??this.defaults)}parseMarkdown(e){return(t,n)=>{let r={...n},i={...this.defaults,...r},a=this.onError(!!i.silent,!!i.async);if(this.defaults.async===!0&&r.async===!1)return a(Error(`marked(): The async option was set to true by an extension. Remove async: false from the parse options object to return a Promise.`));if(typeof t>`u`||t===null)return a(Error(`marked(): input parameter is undefined or null`));if(typeof t!=`string`)return a(Error(`marked(): input parameter is of type `+Object.prototype.toString.call(t)+`, string expected`));if(i.hooks&&(i.hooks.options=i,i.hooks.block=e),i.async)return(async()=>{let n=i.hooks?await i.hooks.preprocess(t):t,r=await(i.hooks?await i.hooks.provideLexer(e):e?j.lex:j.lexInline)(n,i),a=i.hooks?await i.hooks.processAllTokens(r):r;i.walkTokens&&await Promise.all(this.walkTokens(a,i.walkTokens));let o=await(i.hooks?await i.hooks.provideParser(e):e?_t.parse:_t.parseInline)(a,i);return i.hooks?await i.hooks.postprocess(o):o})().catch(a);try{i.hooks&&(t=i.hooks.preprocess(t));let n=(i.hooks?i.hooks.provideLexer(e):e?j.lex:j.lexInline)(t,i);i.hooks&&(n=i.hooks.processAllTokens(n)),i.walkTokens&&this.walkTokens(n,i.walkTokens);let r=(i.hooks?i.hooks.provideParser(e):e?_t.parse:_t.parseInline)(n,i);return i.hooks&&(r=i.hooks.postprocess(r)),r}catch(e){return a(e)}}}onError(e,t){return n=>{if(n.message+=`
Please report this to https://github.com/markedjs/marked.`,e){let e=`<p>An error occurred:</p><pre>`+ot(n.message+``,!0)+`</pre>`;return t?Promise.resolve(e):e}if(t)return Promise.reject(n);throw n}}};function M(e,t){return yt.parse(e,t)}M.options=M.setOptions=function(e){return yt.setOptions(e),M.defaults=yt.defaults,x(M.defaults),M},M.getDefaults=y,M.defaults=b,M.use=function(...e){return yt.use(...e),M.defaults=yt.defaults,x(M.defaults),M},M.walkTokens=function(e,t){return yt.walkTokens(e,t)},M.parseInline=yt.parseInline,M.Parser=_t,M.parser=_t.parse,M.Renderer=ht,M.TextRenderer=gt,M.Lexer=j,M.lexer=j.lex,M.Tokenizer=A,M.Hooks=vt,M.parse=M,M.options,M.setOptions,M.use,M.walkTokens,M.parseInline,_t.parse,j.lex;var bt=(...e)=>e.filter((e,t,n)=>!!e&&e.trim()!==``&&n.indexOf(e)===t).join(` `).trim(),xt=e=>e.replace(/([a-z0-9])([A-Z])/g,`$1-$2`).toLowerCase(),St=e=>e.replace(/^([A-Z])|[\s-_]+(\w)/g,(e,t,n)=>n?n.toUpperCase():t.toLowerCase()),Ct=e=>{let t=St(e);return t.charAt(0).toUpperCase()+t.slice(1)},wt={xmlns:`http://www.w3.org/2000/svg`,width:24,height:24,viewBox:`0 0 24 24`,fill:`none`,stroke:`currentColor`,strokeWidth:2,strokeLinecap:`round`,strokeLinejoin:`round`},Tt=e=>{for(let t in e)if(t.startsWith(`aria-`)||t===`role`||t===`title`)return!0;return!1},Et=(0,_.createContext)({}),Dt=()=>(0,_.useContext)(Et),Ot=(0,_.forwardRef)(({color:e,size:t,strokeWidth:n,absoluteStrokeWidth:r,className:i=``,children:a,iconNode:o,...s},c)=>{let{size:l=24,strokeWidth:u=2,absoluteStrokeWidth:d=!1,color:f=`currentColor`,className:p=``}=Dt()??{},m=r??d?Number(n??u)*24/Number(t??l):n??u;return(0,_.createElement)(`svg`,{ref:c,...wt,width:t??l??wt.width,height:t??l??wt.height,stroke:e??f,strokeWidth:m,className:bt(`lucide`,p,i),...!a&&!Tt(s)&&{"aria-hidden":`true`},...s},[...o.map(([e,t])=>(0,_.createElement)(e,t)),...Array.isArray(a)?a:[a]])}),kt=(e,t)=>{let n=(0,_.forwardRef)(({className:n,...r},i)=>(0,_.createElement)(Ot,{ref:i,iconNode:t,className:bt(`lucide-${xt(Ct(e))}`,`lucide-${e}`,n),...r}));return n.displayName=Ct(e),n},At=kt(`activity`,[[`path`,{d:`M22 12h-2.48a2 2 0 0 0-1.93 1.46l-2.35 8.36a.25.25 0 0 1-.48 0L9.24 2.18a.25.25 0 0 0-.48 0l-2.35 8.36A2 2 0 0 1 4.49 12H2`,key:`169zse`}]]),jt=kt(`arrow-right`,[[`path`,{d:`M5 12h14`,key:`1ays0h`}],[`path`,{d:`m12 5 7 7-7 7`,key:`xquz4c`}]]),Mt=kt(`book-open`,[[`path`,{d:`M12 7v14`,key:`1akyts`}],[`path`,{d:`M3 18a1 1 0 0 1-1-1V4a1 1 0 0 1 1-1h5a4 4 0 0 1 4 4 4 4 0 0 1 4-4h5a1 1 0 0 1 1 1v13a1 1 0 0 1-1 1h-6a3 3 0 0 0-3 3 3 3 0 0 0-3-3z`,key:`ruj8y`}]]),Nt=kt(`chevron-right`,[[`path`,{d:`m9 18 6-6-6-6`,key:`mthhwq`}]]),Pt=kt(`circle-check-big`,[[`path`,{d:`M21.801 10A10 10 0 1 1 17 3.335`,key:`yps3ct`}],[`path`,{d:`m9 11 3 3L22 4`,key:`1pflzl`}]]),Ft=kt(`compass`,[[`circle`,{cx:`12`,cy:`12`,r:`10`,key:`1mglay`}],[`path`,{d:`m16.24 7.76-1.804 5.411a2 2 0 0 1-1.265 1.265L7.76 16.24l1.804-5.411a2 2 0 0 1 1.265-1.265z`,key:`9ktpf1`}]]),It=kt(`git-commit-horizontal`,[[`circle`,{cx:`12`,cy:`12`,r:`3`,key:`1v7zrd`}],[`line`,{x1:`3`,x2:`9`,y1:`12`,y2:`12`,key:`1dyftd`}],[`line`,{x1:`15`,x2:`21`,y1:`12`,y2:`12`,key:`oup4p8`}]]),Lt=kt(`layers`,[[`path`,{d:`M12.83 2.18a2 2 0 0 0-1.66 0L2.6 6.08a1 1 0 0 0 0 1.83l8.58 3.91a2 2 0 0 0 1.66 0l8.58-3.9a1 1 0 0 0 0-1.83z`,key:`zw3jo`}],[`path`,{d:`M2 12a1 1 0 0 0 .58.91l8.6 3.91a2 2 0 0 0 1.65 0l8.58-3.9A1 1 0 0 0 22 12`,key:`1wduqc`}],[`path`,{d:`M2 17a1 1 0 0 0 .58.91l8.6 3.91a2 2 0 0 0 1.65 0l8.58-3.9A1 1 0 0 0 22 17`,key:`kqbvx6`}]]),Rt=kt(`menu`,[[`path`,{d:`M4 5h16`,key:`1tepv9`}],[`path`,{d:`M4 12h16`,key:`1lakjw`}],[`path`,{d:`M4 19h16`,key:`1djgab`}]]),zt=kt(`play`,[[`path`,{d:`M5 5a2 2 0 0 1 3.008-1.728l11.997 6.998a2 2 0 0 1 .003 3.458l-12 7A2 2 0 0 1 5 19z`,key:`10ikf1`}]]),Bt=kt(`search`,[[`path`,{d:`m21 21-4.34-4.34`,key:`14j7rj`}],[`circle`,{cx:`11`,cy:`11`,r:`8`,key:`4ej97u`}]]),Vt=kt(`shield`,[[`path`,{d:`M20 13c0 5-3.5 7.5-7.66 8.95a1 1 0 0 1-.67-.01C7.5 20.5 4 18 4 13V6a1 1 0 0 1 1-1c2 0 4.5-1.2 6.24-2.72a1.17 1.17 0 0 1 1.52 0C14.51 3.81 17 5 19 5a1 1 0 0 1 1 1z`,key:`oel41y`}]]),Ht=kt(`x`,[[`path`,{d:`M18 6 6 18`,key:`1bl5f8`}],[`path`,{d:`m6 6 12 12`,key:`d8bk6v`}]]),Ut={manifest:{filename:`MULA_SPHOTA.md`,attributes:{title:`Mūla Sphoṭa Global Manifest`,type:`manifest`,phase:`Phase 1: Pure Vision`,vedic_state:`Turīya`,description:`The root index of folders, guidelines, safety criteria, and documentation synchronization rules.`},body:`
...
`}],samskaras:[{filename:`samskara_017_portal_styling.json`,sankalpa_id:`sankalpa_017_pages_portal`,task_title:`Vaikharī Documentation Portal Setup & Styling`,summary:`Resolved CSS rendering bugs and native compiler binding crash on GitHub Actions runner.`,resolved_date:`2026-07-14`,critical_learnings:[`Vite template lacked Tailwind config directives, PostCSS packages, and utility maps, resulting in completely unstyled HTML. Refactoring portal view to pure Vanilla CSS variable parameters resolved all styling blocks.`,`Vite v8 native bindings for Rolldown skip optional installation checks on GitHub Actions Linux runner VM environments, causing compiler execution crashes. Adding step 'npm install @rolldown/binding-linux-x64-gnu' before compile resolved the deployment failure.`],associated_adr:`adr_017_github_pages.md`},{filename:`samskara_019_portal_navigation.json`,sankalpa_id:`sankalpa_019_portal_navigation`,task_title:`Portal Collapsible Sidebar and Navigation Context Memory`,summary:`Resolved layout workspace width limits and back-button view resets.`,resolved_date:`2026-07-14`,critical_learnings:[`Fixed-width sidebar layout compressed code reading panes. Created a 'sidebarCollapsed' state in App.jsx and collapsed CSS variable transitions to dynamically hide the sidebar.`,`Clicking Back from document details view reset the user to the homepage dashboard, breaking their guided learning step. Added 'docSource' state memory tracking to redirect back to the active journey node.`],associated_adr:`adr_019_portal_enhancements.md`}],compiledAt:`2026-07-15T02:19:43.660Z`},Wt=o((e=>{var t=Symbol.for(`react.transitional.element`);function n(e,n,r){var i=null;if(r!==void 0&&(i=``+r),n.key!==void 0&&(i=``+n.key),`key`in n)for(var a in r={},n)a!==`key`&&(r[a]=n[a]);else r=n;return n=r.ref,{$$typeof:t,type:e,key:i,ref:n===void 0?null:n,props:r}}e.jsx=n,e.jsxs=n})),N=o(((e,t)=>{t.exports=Wt()}))();M.setOptions({gfm:!0,breaks:!0,headerIds:!1,mangle:!1});function Gt(){let[e,t]=(0,_.useState)(null),[n,r]=(0,_.useState)(!1),[i,a]=(0,_.useState)(!1),[o,s]=(0,_.useState)(0),[c,l]=(0,_.useState)(``),[u,d]=(0,_.useState)(!1),[f,p]=(0,_.useState)(!1),[m,h]=(0,_.useState)(`dashboard`),[g,v]=(0,_.useState)(`generate API documentation index`),[y,b]=(0,_.useState)(null),[x,ee]=(0,_.useState)(!1),S=(0,_.useMemo)(()=>[{number:1,label:`Brahman`,title:`ADR-001: Brahman Foundation ➔ Stateless Core`,vedicTitle:`Vedic Philosophy: Brahman (Absolute Statelessness)`,vedicDesc:`In Advaita philosophy, Brahman is the foundational, immutable, and stateless reality of the universe. All changing phenomena are temporary superimpositions.`,vedicKeyTerms:[`Brahman (Stateless Reality)`,`Adhiṣṭhāna (Foundational Base)`,`Nirguṇa (Attribute-free)`],engTitle:`Software Analogy: Stateless Core Architecture`,engDesc:`AUM is built on a stateless execution model. The engine does not maintain local in-memory session side-effects; all state is reconstructed deterministically from active files.`,engWhy:`This eliminates state-drift and race conditions across turn iterations, ensuring reliable agent executions.`,adrLink:`adr_001_consolidation.md`},{number:2,label:`Guards`,title:`ADR-002: Yamas & Niyamas ➔ System Invariant Guards`,vedicTitle:`Vedic Philosophy: Ethical Restraints & Observances`,vedicDesc:`Patanjali's Yoga Sutras define Yamas (universal ethical restraints like non-injury) and Niyamas (personal rules like purity) to govern human action.`,vedicKeyTerms:[`Yamas (Active Restraints)`,`Niyamas (Internal Code Rules)`,`Ahiṃsā (Safety Invariant)`],engTitle:`Software Analogy: Linter & Compilation Guards`,engDesc:`AUM defines strict compilation guards that block illegal commands, placeholder code stubs, or modifications outside of specified workspace paths.`,engWhy:`This ensures the agent cannot execute unaligned work or write broken syntax, preserving master codebase health.`,adrLink:`adr_002_vedic_guardrails.md`},{number:3,label:`Quarters`,title:`ADR-003: Quarters of Consciousness ➔ State Machine`,vedicTitle:`Vedic Philosophy: Māṇḍūkya's Four Quarters`,vedicDesc:`The Māṇḍūkya Upanishad maps consciousness into four quarters: Jāgrat (waking), Svapna (dreaming/planning), Suṣupti (deep sleep/config), and Turīya (underlying manifest).`,vedicKeyTerms:[`Jāgrat (Intake Phase)`,`Svapna (Plan Phase)`,`Suṣupti (Invariant Phase)`,`Turīya (Manifest Phase)`],engTitle:`Software Analogy: Execution State Machine`,engDesc:`The framework cycles through corresponding phases: Intake (waking requirements), Blueprinting (planning architecture reviews), Invariants (safeguarding ethics limits), and Manifesting (writing files).`,engWhy:`This coordinates AI agent turns into structured, verifiable cognitive steps rather than arbitrary code execution loops.`,adrLink:`adr_003_standardization.md`},{number:4,label:`Customs`,title:`ADR-004: Workspace Customizations ➔ Intent Setup`,vedicTitle:`Vedic Philosophy: Saṅkalpa & Rules Registration`,vedicDesc:`A Saṅkalpa is a solemn vow or intention made with complete focus. Once set, all action (Karma) is aligned solely toward fulfilling this specific resolve.`,vedicKeyTerms:[`Saṅkalpa (Focal Resolve)`,`Ekāgratā (One-pointed Focus)`,`Karma (Aligned Action)`],engTitle:`Software Analogy: Config Customizations Setup`,engDesc:`AUM loads setup parameters from local sankalpas and agents configuration configurations at startup, defining active workspace rules.`,engWhy:`This enables the development team to dynamically adjust linter parameters and active task scopes on a project-by-project basis.`,adrLink:`adr_004_customizations.md`},{number:5,label:`Lifecycle`,title:`ADR-005: Pañcakṛtya ➔ Turn Execution Lifecycle`,vedicTitle:`Vedic Philosophy: Pañcakṛtya (Five Cosmic Actions)`,vedicDesc:`In Shaiva cosmology, the universe flows through five cosmic acts: creation (Sṛṣṭi), maintenance (Sthiti), dissolution (Saṃhāra), concealment (Tirobhāva), and grace (Anugraha).`,vedicKeyTerms:[`Sṛṣṭi (File Creation)`,`Saṃhāra (Cleanup/Negation)`,`Anugraha (Commit/Push)`],engTitle:`Software Analogy: Execution Turn States`,engDesc:`Agent execution runs through corresponding states: context assembly (Sṛṣṭi), diff review (Sthiti), refactoring pruning (Saṃhāra), output rendering (Tirobhāva), and commit deployment (Anugraha).`,engWhy:`This structures execution turns into a systematic loop, ensuring that code is compiled and validated before deployment.`,adrLink:`adr_005_pancakritya_lifecycle.md`},{number:6,label:`Registry`,title:`ADR-006: Mūla Sphoṭa ➔ Framework Registry`,vedicTitle:`Vedic Philosophy: Sphoṭa (Holistic Sound/Concept Burst)`,vedicDesc:`In grammar philosophy, Sphoṭa is the sudden cognitive flash of the entire semantic meaning of a word, overriding individual letters or syllables.`,vedicKeyTerms:[`Mūla Sphoṭa (Root Manifest)`,`Nāda (Vibration)`,`Sphurana (Flashing)`],engTitle:`Software Analogy: Root Manifest Registry`,engDesc:`AUM registers the entire workspace file inventory, active reviews, decisions, and instructions under the Mūla Sphoṭa global manifest.`,engWhy:`This provides a unified index of the codebase, ensuring that AI agents can find all relevant references.`,adrLink:`adr_006_mula_sphota.md`},{number:7,label:`Retro`,title:`ADR-007: Pratyavēkṣaṇa ➔ Retrospective Audits`,vedicTitle:`Vedic Philosophy: Pratyavēkṣaṇa (Self-Reflection)`,vedicDesc:`Pratyavēkṣaṇa is the cognitive practice of self-observation and reflection, looking back on one's actions to identify mistakes and refine understanding.`,vedicKeyTerms:[`Pratyavēkṣaṇa (Self-Reflection)`,`Doṣa (Flaw Detection)`,`Śodhana (Purification)`],engTitle:`Software Analogy: Task Retrospective Logs`,engDesc:`Every task completion requires writing a retrospective review mapping what was learned, what errors occurred, and how they were corrected.`,engWhy:`This builds a cumulative database of workspace-specific learnings that future agent runs load to avoid repeating mistakes.`,adrLink:`adr_007_pratyaveksana.md`},{number:8,label:`Overrides`,title:`ADR-009: Mīmāṃsā Hermeneutics ➔ Overrides Hierarchy`,vedicTitle:`Vedic Philosophy: Text Interpretation Rules`,vedicDesc:`Mīmāṃsā defines a strict hierarchy to interpret and resolve overlapping or conflicting scriptural commands: Direct Text (Śruti) overrides Inference (Liṅga) overrides Sentence Context (Vākya) overrides Section Context (Prakaraṇa).`,vedicKeyTerms:[`Śruti (Direct Configuration)`,`Liṅga (Inferred/Linter Hint)`,`Vākya (Module Scope)`,`Prakaraṇa (Global Rules)`],engTitle:`Software Analogy: Config Hierarchy resolution`,engDesc:`AUM resolves configuration overrides in the same order. Direct settings (Śruti) override linter diagnostic suggestions (Liṅga) which override local module settings (Vākya) which override global rules.`,engWhy:`This eliminates configuration ambiguity when different rule sets overlap, resolving them programmatically without human intervention.`,adrLink:`adr_009_mimamsa_hermeneutics.md`},{number:9,label:`Ontology`,title:`ADR-010: Vaiśeṣika Categories ➔ Data Models`,vedicTitle:`Vedic Philosophy: Vaiśeṣika Padārthas (Categories)`,vedicDesc:`The Vaiśeṣika system classifies everything in the universe into six categories: substance (Dravya), quality (Guṇa), action (Karma), generality (Sāmānya), particularity, and inherence.`,vedicKeyTerms:[`Dravya (Substance/Object)`,`Guṇa (Attribute/Property)`,`Karma (Method/Action)`],engTitle:`Software Analogy: AST Node Type Models`,engDesc:`Data schemas in AUM map directly to Padārthas. Objects are Dravya, properties/types are Guṇa, and logic methods are Karma.`,engWhy:`This provides a clean, ontological classification system for organizing software components and data structures.`,adrLink:`adr_010_vaisesika_ontologies.md`},{number:10,label:`Build`,title:`ADR-011: Sāṅkhya Evolution ➔ Build Lifecycle`,vedicTitle:`Vedic Philosophy: Sāṅkhya Material Evolution`,vedicDesc:`In Sāṅkhya philosophy, physical reality (Bhūtas) is not static. It evolves systematically from unmanifest root nature (Prakṛti) through cosmic intellect (Buddhi), self-identity (Ahaṅkāra), and the senses (Indriyas) into physical matter.`,vedicKeyTerms:[`Prakṛti (Root Nature)`,`Buddhi (Syntax Check)`,`Ahaṅkāra (Linking)`,`Bhūtas (Compiled Output)`],engTitle:`Software Analogy: Compiling and Linking`,engDesc:`AUM compiles source files in the same order. Raw uncompiled code (Prakṛti) undergoes syntactic AST analysis (Buddhi), generates object linking namespaces (Ahaṅkāra), and finally produces compiled outputs (Bhūtas).`,engWhy:`This formalizes the pipeline states of our build, ensuring that modifications flow sequentially from source to distribution without state pollution.`,adrLink:`adr_011_sankhye_evolution.md`},{number:11,label:`Sandbox`,title:`ADR-012: Shaiva Kañcukas ➔ Security Limits`,vedicTitle:`Vedic Philosophy: The Five Limiting Sheaths`,vedicDesc:`In Shaivism, the infinite power of consciousness (Shiva) is limited by sheaths (Kañcukas) to allow individual agency: time (Kāla), space (Niyati), desire (Rāga), knowledge (Vidyā), and power (Kalā).`,vedicKeyTerms:[`Kāla (Turns Limit)`,`Niyati (Directory Bounds)`,`Rāga (Saṅkalpa Focus)`,`Vidyā/Kalā (Tool Security)`],engTitle:`Software Analogy: Secure Runtime Sandboxing`,engDesc:`AI agents operate with specific runtime limits: Turn limits (Kāla) prevent loops, Workspace restrictions (Niyati) protect local files, Active Saṅkalpa scopes (Rāga) focus edits, and tool blocks (Kalā) limit networking.`,engWhy:`This establishes absolute execution boundaries, preventing AI agents from executing dangerous terminal commands or writing outside the workspace.`,adrLink:`adr_012_shaiva_kancukas.md`},{number:12,label:`Streams`,title:`ADR-013: Spanda Pulsation ➔ WebSocket Streams`,vedicTitle:`Vedic Philosophy: Spanda (Dynamic Pulse)`,vedicDesc:`Spanda philosophy describes the universe as a dynamic, vibrating pulse. It manifests through opening (Unmeṣa / creation) and closing (Nimeṣa / withdrawal) phases, maintaining cosmic balance.`,vedicKeyTerms:[`Unmeṣa (Event Emission)`,`Nimeṣa (Subscription Cleanup)`,`Spanda-Sandhi (Debounce/Interval)`],engTitle:`Software Analogy: Event-Driven WebSockets`,engDesc:`Reactive streams operate via opening and closing pulses. Events are emitted during Unmeṣa, event listeners and WebSocket subscriptions are cleared during Nimeṣa, and stream intervals are throttled in Spanda-Sandhi.`,engWhy:`This prevents memory leaks in WebSocket and event connections, ensuring that every opened channel is systematically closed.`,adrLink:`adr_013_spanda_reactive.md`},{number:13,label:`Refactoring`,title:`ADR-014: Advaita Vedānta ➔ Code Negation`,vedicTitle:`Vedic Philosophy: Negation (Apavāda / Neti Neti)`,vedicDesc:`Advaita Vedānta uses negation (Apavāda - 'Neti Neti' or 'not this, not this') to strip away illusions and superimpositions (Adhyāsa) to realize ultimate unity (Brahman).`,vedicKeyTerms:[`Adhyāsa (Bloat Superimposition)`,`Apavāda (Negation/Neti-Neti)`,`Brahman (Single Source of Truth)`],engTitle:`Software Analogy: Code De-duplication`,engDesc:`Boilerplate and duplicate files (Adhyāsa) are systematically negated and removed (Apavāda) during build cleaning, consolidating codebases into a single, unified source of truth (Brahman).`,engWhy:`This ensures the codebase stays extremely lean, preventing bloated copy-paste boilerplate from drifting the logic.`,adrLink:`adr_014_advaita_refactoring.md`},{number:14,label:`Typing`,title:`ADR-015: Navya-Nyāya Logic ➔ Strict Typing (AST)`,vedicTitle:`Vedic Philosophy: Symbolic Category Logic`,vedicDesc:`Navya-Nyāya provides a formal symbolic language to describe properties and relations without ambiguity. Every statement defines a subject (Dharmin), its qualifiers, and relation limiters (Avacchedaka).`,vedicKeyTerms:[`Dharmin (Type Signature)`,`Avacchedaka (Type Limiter)`,`Samavāya (Subclass Relation)`],engTitle:`Software Analogy: AST Invariant Boundaries`,engDesc:`AUM enforces strict type safety during AST transformations. Every parameter must define a type (Dharmin), generics must use constraints/limiters (Avacchedaka), and class inheritances must map strictly (Samavāya).`,engWhy:`This prevents type coercion and runtime crashes by validating structural specifications before execution.`,adrLink:`adr_015_navya_nyaya_ast.md`},{number:15,label:`Reviews`,title:`ADR-016: Vāda-Vidhī Debate ➔ Branch Code Reviews`,vedicTitle:`Vedic Philosophy: Rules of Logical Debate`,vedicDesc:`Vāda-Vidhī structures truth-seeking debate (Vāda). It defines the parts of a valid proposition (Pratijñā), logical fallacies (Hētvābhāsa), and grounds under which an argument is declared defeated (Nigrahasthāna).`,vedicKeyTerms:[`Pratijñā (PR Intent)`,`Hetu (Git Diff/Evidence)`,`Hētvābhāsa (Syntax Fallacy)`,`Nigrahasthāna (Build Block)`],engTitle:`Software Analogy: PR Verification & Merges`,engDesc:`Pull requests are audited as logical debates. The branch declares a proposition (Pratijñā), the git diff provides evidence (Hetu), code issues are flagged as fallacies (Hētvābhāsa), and build errors trigger defeat (Nigrahasthāna).`,engWhy:`This guarantees master branch stability by programmatically blocking PRs that fail basic compilation or type checks.`,adrLink:`adr_016_vada_vidhi_reviews.md`},{number:16,label:`Portal`,title:`ADR-017: Vaikharī Pages ➔ Documentation Deployment`,vedicTitle:`Vedic Philosophy: Vaikharī (Spoken Word)`,vedicDesc:`In Bhartṛhari's philosophy of language, Vaikharī is the final, outer spoken form of sound—making the unmanifest thought audible to others.`,vedicKeyTerms:[`Vaikharī (Spoken Word)`,`Madhyamā (Mental Structure)`,`Paśyantī (Primary Intent)`],engTitle:`Software Analogy: GitHub Pages Static Site`,engDesc:`AUM builds a React static documentation portal (Vaikharī) from its underlying JSON schemas (Madhyamā) and pushes them to GitHub Pages for developers to read.`,engWhy:`This makes the framework documentation public, readable, and interactive for developers worldwide.`,adrLink:`adr_017_github_pages.md`},{number:17,label:`Roadmap`,title:`ADR-018: Upamāna Journey ➔ Interactive Roadmap`,vedicTitle:`Vedic Philosophy: Upamāna (Epistemological Analogy)`,vedicDesc:`Upamāna is the process of learning by analogy—gaining knowledge of an unfamiliar subject by matching it to a familiar one.`,vedicKeyTerms:[`Upamāna (Analogy)`,`Sādharmya (Similarity)`,`Pramā (Valid Knowledge)`],engTitle:`Software Analogy: Guided Roadmap UI`,engDesc:`The onboarding journey maps Sanskrit metaphysics side-by-side with familiar design patterns to build quick understanding.`,engWhy:`This resolves developer onboarding friction and eliminates the need for prior classical training.`,adrLink:`adr_018_onboarding_journey.md`},{number:18,label:`Layouts`,title:`ADR-019: Portal Layouts ➔ Collapsible Workspace`,vedicTitle:`Vedic Philosophy: Dharā-Vāha-Smṛti (Unbroken Stream)`,vedicDesc:`Dharā-Vāha-Smṛti is the continuous, cognitive tracking of state flow. In workspace interactions, a user should never suffer context breakage or navigation reset.`,vedicKeyTerms:[`Dharā (Flow)`,`Smṛti (Memory State)`,`Vikṣepa (Distraction Block)`],engTitle:`Software Analogy: Context-Sensitive Navigation`,engDesc:`The UI tracks navigation sources and provides sidebar toggles, expanding reading viewport spaces without losing user session coordinates.`,engWhy:`This ensures the developer stays focused during dense codebase research, improving navigation convenience.`,adrLink:`adr_019_portal_enhancements.md`},{number:19,label:`Memory Cache`,title:`ADR-020: Persistent Caching ➔ Saṃskāra Memory`,vedicTitle:`Vedic Philosophy: Saṃskāras (Subconscious Impressions)`,vedicDesc:`Every experience leaves a subconscious impression (Saṃskāra). Over time, these impressions shape active behavioral tendencies (Vāsanās).`,vedicKeyTerms:[`Saṃskāras (Impressions)`,`Vāsanās (Tendencies)`,`Smṛti (Memory Retention)`],engTitle:`Software Analogy: Experience JSON Logs Cache`,engDesc:`The framework logs task resolutions, linter gotchas, and VM env patches to JSON files. Future agent runs load these caches to inherit past experience patterns.`,engWhy:`This prevents developer agents from hitting the same compiler native binding or configuration errors repeatedly across runs.`,adrLink:`adr_020_samskara_memory.md`},{number:20,label:`Linter Auditor`,title:`ADR-021: Programmatic Linter ➔ Hētvābhāsa Fallacies`,vedicTitle:`Vedic Philosophy: Logic Fallacies (Hētvābhāsa)`,vedicDesc:`In Nyāya epistemology, logical arguments are audited for fallacies (Hētvābhāsa) such as unproved premises (Asiddha) or out-of-scope edits (Savyabhicāra).`,vedicKeyTerms:[`Asiddha (Unproved/Stub)`,`Savyabhicāra (Irregular/Scope-drift)`,`Nigraha (Commit Block)`],engTitle:`Software Analogy: Git Pre-commit Validator`,engDesc:`A Node pre-commit script audits staged git files, scanning for commented stubs, console logs, or file modifications outside the active focus lock.`,engWhy:`This guarantees master branch integrity by automatically blocking unaligned commits or placeholder code blocks.`,adrLink:`adr_021_hetvabhasa_auditor.md`},{number:21,label:`Context Pruner`,title:`ADR-022: Attention Pruning ➔ Pratyāhāra Context`,vedicTitle:`Vedic Philosophy: Sensory Abstraction (Pratyāhāra)`,vedicDesc:`Pratyāhāra represents the withdrawal of senses from external noise. It shields the mind from distraction to ensure absolute cognitive concentration.`,vedicKeyTerms:[`Pratyāhāra (Abstraction)`,`Vikṣepa (Distraction Pruning)`,`Ekāgratā (One-pointed Focus)`],engTitle:`Software Analogy: Workspace Context Compressor`,engDesc:`A context compressor dynamically prunes unrelated dependency nodes, build outputs, and logs, compiling a minimal task-specific file inventory.`,engWhy:`This protects finite context windows from token bloat, ensuring instructions are not forgotten during long agent runs.`,adrLink:`adr_022_pratyahara_context.md`},{number:22,label:`Self Healer`,title:`ADR-023: Self-Healing Runner ➔ Prāyaścitta Recovery`,vedicTitle:`Vedic Philosophy: Atonement & Correction (Prāyaścitta)`,vedicDesc:`Prāyaścitta refers to self-cleansing rituals and corrective behaviors performed to repair past deviations and restore system equilibrium.`,vedicKeyTerms:[`Prāyaścitta (Correction)`,`Doṣa (Runtime Deviation)`,`Śuddhi (System Purification)`],engTitle:`Software Analogy: Self-Correcting Test Runner`,engDesc:`A test wrapper catches compilation crashes, maps issues to correction profiles (such as native Rolldown binds on Linux runner VMs), runs patches, and retries.`,engWhy:`This prevents minor native environment binding mismatches from crashing CI/CD delivery pipelines.`,adrLink:`adr_023_prayascitta_recovery.md`},{number:23,label:`Orchestrator`,title:`ADR-024: CLI Entry ➔ AUM Intent Orchestrator`,vedicTitle:`Vedic Philosophy: Combined Samyama (Total Coordination)`,vedicDesc:`Samyama is the combined practice of Dharana (focus), Dhyana (meditation), and Samadhi (absorption). It represents the absolute synthesis and orchestration of cognitive capacities.`,vedicKeyTerms:[`Samyama (Combined Synthesis)`,`Manas (Central Coordinator)`,`Kriyā (Coordinated Action)`],engTitle:`Software Analogy: CLI Lifecycle Orchestrator`,engDesc:`A central Node script 'scripts/aum.js' wraps all linter, context pruner, compiler self-healer, and doc parser scripts into simplified commands.`,engWhy:`This consolidates cognitive lifecycles (Pañcakṛtya) under a single entry point, ensuring uniform check executions during turn runs.`,adrLink:`adr_024_cli_orchestrator.md`},{number:24,label:`Sheath Dispatch`,title:`ADR-025: Intake Classifier ➔ Kañcukas Dispatcher`,vedicTitle:`Vedic Philosophy: Dynamic Sheaths (Kañcukas Sandboxes)`,vedicDesc:`In Shaiva metaphysics, the absolute Shiva limits infinite power through sheaths (Kañcukas) to manifest focused, safe agency.`,vedicKeyTerms:[`Kañcukas (Limiting Sheaths)`,`Prāṇa (Light Intake)`,`Sādhaka (Focused Agent)`],engTitle:`Software Analogy: Low-Latency Intent Sandbox`,engDesc:`A classifier pre-processor script 'scripts/dispatcher.js' categorizes developer strings in under 150ms and dynamically sets turn budgets and tool write scopes.`,engWhy:`This eliminates context window lag and prevents unaligned actions by programmatically sandboxing the agent before system prompt calls.`,adrLink:`adr_025_kancuka_dispatcher.md`},{number:25,label:`Yogi Guardian`,title:`ADR-026: Resident Agent ➔ Yogi Goptrī`,vedicTitle:`Vedic Philosophy: The Goptrī (Resident Guardian)`,vedicDesc:`The Goptrī represents the protector who guards the sacred code of conduct and maintains focus to fulfill the primary Saṅkalpa resolve.`,vedicKeyTerms:[`Goptrī (Protector)`,`Sādhaka (Yogi Practitioner)`,`Samādhi (Unbroken Focus)`],engTitle:`Software Analogy: Workspace Customization Agent`,engDesc:`A resident agent skill 'Yogi' defined inside '.agents/skills/yogi/' auto-triggers during workspace initialization to guide developers and enforce invariants.`,engWhy:`This ensures that whenever the framework is downloaded or cloned, Yogi comes alive to guide developer prompts and maintain architectural alignment.`,adrLink:`adr_026_yogi_guardian.md`},{number:26,label:`Pranayama`,title:`ADR-027: Context Ventilation ➔ Prāṇāyāma`,vedicTitle:`Vedic Philosophy: Prāṇāyāma (Breath Control)`,vedicDesc:`Prāṇāyāma regulates the breath through inhalation (Pūraka), retention (Kumbhaka), and exhalation (Recaka) to purify focus.`,vedicKeyTerms:[`Pūraka (Inhalation)`,`Kumbhaka (Retention)`,`Recaka (Exhalation)`],engTitle:`Software Analogy: Token Limit Compressor`,engDesc:`A context compressor script 'scripts/pranayama.js' filters raw session logs, retaining pinned instructions and targets while pruning build outputs.`,engWhy:`This prevents instruction decay inside the context window during long-running engineering runs.`,adrLink:`adr_027_pranayama.md`},{number:27,label:`Bhavana`,title:`ADR-028: Rule Incubator ➔ Sphoṭa-Bhāvanā`,vedicTitle:`Vedic Philosophy: Bhāvanā (Continuous Incubation)`,vedicDesc:`Bhāvanā is the persistent cognitive incubation of subconscious impressions that matures ideas into fully articulated reality.`,vedicKeyTerms:[`Bhāvanā (Incubation)`,`Sphoṭa (Holistic Flashing)`,`Saṃskāras (Impressions)`],engTitle:`Software Analogy: Dynamic Prompt Evolution`,engDesc:`A rule compiler script 'scripts/bhavana.js' synthesizes memory logs from '.aum/samskaras/' and auto-appends newly learned rules to the configuration files.`,engWhy:`This lets the prompt rules automatically evolve and learn from past compilation vm environments adjustments.`,adrLink:`adr_028_bhavana.md`},{number:28,label:`Upayas`,title:`ADR-029: Recovery Resolver ➔ Catur-Upāya`,vedicTitle:`Vedic Philosophy: Catur-Upāya (Four Strategies)`,vedicDesc:`The Upāyas are four classical methods to resolve conflict or achieve state objectives: Sama (conciliation), Dana (compensation), Bheda (division), and Danda (force).`,vedicKeyTerms:[`Sāma (Soft override)`,`Dāna (Stub injection)`,`Bheda (Code separation)`,`Daṇḍa (Git rollback)`],engTitle:`Software Analogy: Progressive Error Recovery`,engDesc:`An error recovery state machine 'scripts/upaya.js' sequentially applies warning overrides (Sāma), import stubbing (Dāna), dependency isolation (Bheda), and check resets (Daṇḍa) on compiler crashes.`,engWhy:`This ensures the system can recover from complex compile issues without crashing the continuous integration runs.`,adrLink:`adr_029_upaya.md`},{number:29,label:`Panini`,title:`ADR-030: Code Synthesizer ➔ Pāṇinian Grammar`,vedicTitle:`Vedic Philosophy: Panini's Aṣṭādhyāyī (Semantic Grammar)`,vedicDesc:`Pāṇini formulated 3,959 algebraic sutra rules to generate Sanskrit syntax, representing the earliest context-free generative metalanguage.`,vedicKeyTerms:[`Dhātu (Semantic Root)`,`Pratyaya (Modifier)`,`Sūtra (Parsing Rule)`],engTitle:`Software Analogy: Generative AST Compiler`,engDesc:`A parsing code generator 'scripts/panini.js' translates root intent descriptors into mathematically correct class declarations using rule-rewriting chains.`,engWhy:`This eliminates code typos and boilerplate bloat by generating source files via formal logic chains.`,adrLink:`adr_030_panini.md`},{number:30,label:`Catuskoti`,title:`ADR-031: Assertion Logic ➔ Catuṣkoṭi Engine`,vedicTitle:`Vedic Philosophy: Catuṣkoṭi Tetralemma Logic`,vedicDesc:`Catuṣkoṭi is the classical Indian tetralemma logic asserting four state alternatives: Is, Is Not, Both, and Neither.`,vedicKeyTerms:[`Sat (Exists)`,`Asat (Does not exist)`,`Ubhaya (Both)`,`Anubhaya (Neither)`],engTitle:`Software Analogy: Non-Binary Test assertions`,engDesc:`A test validation module 'scripts/catuskoti.js' models async stream assertions under resolved (Sat), rejected (Asat), cache-fetch (Ubhaya), and pending (Anubhaya) states.`,engWhy:`This permits auditing complex race conditions and streaming parameters that binary unit tests cannot model.`,adrLink:`adr_031_catuskoti.md`},{number:31,label:`Pratyabhijna`,title:`ADR-032: Environmental Auditor ➔ Pratyabhijñā`,vedicTitle:`Vedic Philosophy: Pratyabhijñā (Self-Recognition)`,vedicDesc:`Pratyabhijñā is the recognition of one's absolute, internal capabilities rather than acquiring new external variables.`,vedicKeyTerms:[`Pratyabhijñā (Self-recognition)`,`Vimarśa (Self-audit)`,`Jñāna (Identity)`],engTitle:`Software Analogy: Environment Diagnostic Auto-Aligner`,engDesc:`A diagnostic script 'scripts/pratyabhijna.js' checks host OS, node versions, and directory access permissions to align agent limits.`,engWhy:`This ensures the agent can auto-align execution commands across different development laptops and runners.`,adrLink:`adr_032_pratyabhijna.md`}],[]),C=(0,_.useMemo)(()=>[{id:`manifest`,name:`Turīya (Manifest)`,icon:Ft,items:Ut.manifest?[Ut.manifest]:[]},{id:`instructions`,name:`Suṣupti (Manuals)`,icon:Vt,items:Ut.instructions?[Ut.instructions]:[]},{id:`adrs`,name:`Suṣupti (Decisions)`,icon:Pt,items:Ut.adrs||[]},{id:`arbs`,name:`Svapna (Reviews)`,icon:Mt,items:Ut.arbs||[]},{id:`samskaras`,name:`Saṃskāras (Memories)`,icon:Lt,items:(Ut.samskaras||[]).map(e=>({filename:e.filename,attributes:{title:e.task_title||e.sankalpa_id,type:`cognitive_memory`,phase:e.sankalpa_id},body:`## Cognitive Memory: ${e.task_title}\n\n**Summary:** ${e.summary}\n\n**Resolved Date:** ${e.resolved_date}\n\n### Critical Learnings\n${e.critical_learnings.map(e=>`* ${e}`).join(`
`)}\n\n**Associated ADR:** [${e.associated_adr}](.aum/architecture/decisions/${e.associated_adr})`}))}],[]),te=(0,_.useMemo)(()=>{if(!c.trim())return C;let e=c.toLowerCase();return C.map(t=>{let n=t.items.filter(t=>{let n=t.attributes?.title?.toLowerCase().includes(e)||!1,r=t.body?.toLowerCase().includes(e)||!1,i=t.filename?.toLowerCase().includes(e)||!1;return n||r||i});return{...t,items:n}}).filter(e=>e.items.length>0)},[C,c]),w=(e,n=`dashboard`)=>{t(e),h(n),r(!1),a(!1),d(!1),window.scrollTo({top:0,behavior:`smooth`})},ne=(0,_.useMemo)(()=>{if(!e)return null;let t=(e.attributes?.title?`# ${e.attributes.title}\n\n`:``)+e.body;return{__html:M.parse(t)}},[e]),T=(0,_.useMemo)(()=>({totalAdrs:Ut.adrs?.length||0,totalArbs:Ut.arbs?.length||0,compiledAt:Ut.compiledAt?new Date(Ut.compiledAt).toLocaleDateString():`N/A`}),[]),re=S[o],ie=e=>{let t=[...Ut.manifest?[Ut.manifest]:[],...Ut.instructions?[Ut.instructions]:[],...Ut.adrs||[],...Ut.arbs||[],...C.find(e=>e.id===`samskaras`).items].find(t=>t.filename===e);t&&w(t,`journey`)};return(0,N.jsxs)(`div`,{className:`aum-app`,children:[(0,N.jsxs)(`aside`,{className:`aum-sidebar ${u?`open`:``} ${f?`collapsed`:``}`,children:[(0,N.jsxs)(`div`,{className:`aum-sidebar-header`,children:[(0,N.jsxs)(`div`,{className:`aum-brand`,children:[(0,N.jsx)(`div`,{className:`aum-logo`,children:`ॐ`}),(0,N.jsxs)(`div`,{children:[(0,N.jsx)(`h2`,{className:`aum-brand-title`,children:`AUM Engine`}),(0,N.jsx)(`span`,{className:`aum-brand-sub`,children:`Vaikharī Portal`})]})]}),(0,N.jsx)(`button`,{onClick:()=>d(!1),style:{background:`none`,border:`none`,color:`#94a3b8`,cursor:`pointer`,display:`flex`,alignItems:`center`},className:`lg-hidden-btn`,children:(0,N.jsx)(Ht,{size:20})})]}),(0,N.jsxs)(`div`,{className:`aum-search-container`,children:[(0,N.jsx)(Bt,{className:`aum-search-icon`,size:16}),(0,N.jsx)(`input`,{type:`text`,placeholder:`Search documentation...`,value:c,onChange:e=>l(e.target.value),className:`aum-search-input`})]}),(0,N.jsxs)(`button`,{onClick:()=>{r(!1),a(!1),t(null),d(!1)},className:`aum-dashboard-btn ${!e&&!n&&!i?`active`:``}`,style:{marginBottom:`10px`},children:[(0,N.jsx)(At,{size:18}),(0,N.jsx)(`span`,{children:`Cognitive Dashboard`})]}),(0,N.jsxs)(`button`,{onClick:()=>{a(!0),r(!1),t(null),d(!1)},className:`aum-dashboard-btn ${i?`active`:``}`,style:{marginBottom:`10px`},children:[(0,N.jsx)(zt,{size:18}),(0,N.jsx)(`span`,{children:`Sādhana Arena Simulator`})]}),(0,N.jsxs)(`button`,{onClick:()=>{r(!0),a(!1),t(null),d(!1)},className:`aum-dashboard-btn ${n?`active`:``}`,style:{marginBottom:`24px`},children:[(0,N.jsx)(Ft,{size:18}),(0,N.jsx)(`span`,{children:`Vedic Onboarding Journey`})]}),(0,N.jsx)(`nav`,{className:`aum-nav`,children:te.map(t=>(0,N.jsxs)(`div`,{className:`aum-nav-section`,children:[(0,N.jsxs)(`div`,{className:`aum-nav-section-header`,children:[(0,N.jsx)(t.icon,{size:14,style:{color:`#fbbf24`}}),(0,N.jsx)(`span`,{className:`aum-nav-section-title`,children:t.name})]}),(0,N.jsx)(`ul`,{className:`aum-nav-list`,children:t.items.map(t=>{let n=t.attributes?.title||t.filename;return(0,N.jsx)(`li`,{children:(0,N.jsxs)(`button`,{onClick:()=>w(t,`dashboard`),className:`aum-nav-btn ${e?.filename===t.filename?`active`:``}`,children:[(0,N.jsx)(`span`,{children:n}),(0,N.jsx)(Nt,{className:`aum-nav-chevron`,size:12})]})},t.filename)})})]},t.id))})]}),(0,N.jsxs)(`div`,{className:`aum-main-content`,children:[(0,N.jsxs)(`header`,{className:`aum-mobile-header`,children:[(0,N.jsxs)(`div`,{className:`aum-brand`,children:[(0,N.jsx)(`div`,{className:`aum-logo`,children:`ॐ`}),(0,N.jsx)(`h1`,{className:`aum-brand-title`,children:`AUM Engine`})]}),(0,N.jsx)(`button`,{onClick:()=>d(!0),style:{background:`none`,border:`none`,color:`#f8fafc`,cursor:`pointer`},children:(0,N.jsx)(Rt,{size:24})})]}),(0,N.jsxs)(`main`,{className:`aum-main-viewport`,children:[(0,N.jsxs)(`button`,{onClick:()=>p(!f),className:`aum-toggle-sidebar-btn desktop-only-btn`,children:[(0,N.jsx)(Rt,{size:16}),(0,N.jsx)(`span`,{children:f?`Expand Sidebar`:`Collapse Sidebar`})]}),e?(0,N.jsxs)(`div`,{className:`aum-article-view`,children:[(0,N.jsxs)(`button`,{onClick:()=>{t(null),m===`journey`?r(!0):m===`simulator`?a(!0):(r(!1),a(!1))},className:`aum-back-btn`,children:[`← Back `,m===`journey`?`to Journey`:m===`simulator`?`to Simulator`:`to Dashboard`]}),(0,N.jsxs)(`article`,{className:`aum-article-card glass-panel`,children:[e.attributes&&(0,N.jsxs)(`div`,{className:`aum-article-meta`,children:[e.attributes.phase&&(0,N.jsxs)(`span`,{className:`aum-meta-tag`,children:[`📁 `,e.attributes.phase]}),e.attributes.vedic_state&&(0,N.jsxs)(`span`,{className:`aum-meta-tag`,children:[`👁️ State: `,e.attributes.vedic_state]}),e.attributes.type&&(0,N.jsxs)(`span`,{className:`aum-meta-tag`,children:[`🛡️ `,e.attributes.type]})]}),(0,N.jsx)(`div`,{className:`markdown-body`,dangerouslySetInnerHTML:ne})]})]}):i?(0,N.jsxs)(`div`,{style:{maxWidth:`900px`,margin:`0 auto`,display:`flex`,flexDirection:`column`,gap:`32px`},children:[(0,N.jsxs)(`div`,{className:`aum-journey-header`,children:[(0,N.jsx)(`span`,{className:`aum-tag`,children:`Kañcukas Sandboxing Playground`}),(0,N.jsx)(`h1`,{className:`aum-journey-title`,children:`Sādhana Arena Simulator`}),(0,N.jsx)(`p`,{className:`aum-journey-subtitle`,children:`Input a developer prompt to witness Yogi's classification latency (Prāṇa) and see the sheaths constraints (Kañcukas) dynamically cage prompt payload targets.`})]}),(0,N.jsxs)(`div`,{className:`glass-panel`,style:{padding:`24px`},children:[(0,N.jsx)(`label`,{style:{display:`block`,fontWeight:`700`,color:`var(--accent-gold)`,marginBottom:`8px`,fontSize:`0.85rem`,textTransform:`uppercase`},children:`Select or Enter Developer Prompt`}),(0,N.jsxs)(`div`,{style:{display:`flex`,gap:`8px`,flexWrap:`wrap`,marginBottom:`16px`},children:[(0,N.jsx)(`button`,{onClick:()=>v(`fix build compilation error`),className:`aum-tag hover-btn`,style:{cursor:`pointer`},children:`Fix Error`}),(0,N.jsx)(`button`,{onClick:()=>v(`refactor duplicate loops`),className:`aum-tag hover-btn`,style:{cursor:`pointer`},children:`Refactor Loops`}),(0,N.jsx)(`button`,{onClick:()=>v(`generate API index guide`),className:`aum-tag hover-btn`,style:{cursor:`pointer`},children:`Generate Docs`})]}),(0,N.jsx)(`textarea`,{value:g,onChange:e=>v(e.target.value),placeholder:`Enter a prompt...`,style:{width:`100%`,minHeight:`80px`,padding:`12px`,border:`1px solid var(--border-color)`,borderRadius:`8px`,fontFamily:`inherit`,fontSize:`0.9rem`,backgroundColor:`rgba(253, 250, 244, 0.5)`,color:`var(--text-primary)`,resize:`vertical`,marginBottom:`16px`}}),(0,N.jsxs)(`button`,{onClick:()=>{ee(!0),setTimeout(()=>{let e=g.toLowerCase(),t=`GENERAL_DEVELOPER`,n=[`read_file`,`write_file`,`run_command`],r=10,i=`READ-WRITE`;e.includes(`fix`)||e.includes(`debug`)||e.includes(`bug`)||e.includes(`error`)?(t=`DEBUGGER`,n=[`read_file`,`write_file`,`run_command`],r=5):e.includes(`refactor`)||e.includes(`de-duplicate`)||e.includes(`clean`)||e.includes(`formatting`)?(t=`REFACTORER`,n=[`read_file`,`write_file`],r=8):(e.includes(`document`)||e.includes(`doc`)||e.includes(`guide`)||e.includes(`index`))&&(t=`DOCUMENTER`,n=[`read_file`],r=3,i=`READ-ONLY`),b({category:t,allowedTools:n,turnLimit:r,permission:i,latency:Math.floor(Math.random()*5)+1}),ee(!1)},450)},disabled:x,style:{padding:`12px 24px`,backgroundColor:`var(--accent-saffron)`,color:`#fff`,border:`none`,borderRadius:`8px`,fontWeight:`700`,fontSize:`0.9rem`,cursor:`pointer`,display:`flex`,alignItems:`center`,gap:`8px`},children:[(0,N.jsx)(zt,{size:16,fill:`white`}),x?`Classifying (Prāṇa)...`:`Dispatch through Kañcukas`]})]}),y&&(0,N.jsxs)(`div`,{className:`glass-panel`,style:{padding:`32px`},children:[(0,N.jsxs)(`h3`,{style:{fontFamily:`var(--font-display)`,fontSize:`1.25rem`,color:`var(--text-primary)`,marginBottom:`4px`},children:[`Sphoṭa Category: `,y.category]}),(0,N.jsxs)(`span`,{style:{fontSize:`0.8rem`,color:`var(--text-muted)`},children:[`Intake Latency: `,y.latency,`ms`]}),(0,N.jsxs)(`div`,{style:{display:`grid`,gridTemplateColumns:`repeat(auto-fit, minmax(200px, 1fr))`,gap:`16px`,marginTop:`24px`,marginBottom:`24px`},children:[(0,N.jsxs)(`div`,{style:{padding:`16px`,backgroundColor:`rgba(253, 250, 244, 0.5)`,borderRadius:`8px`,border:`1px solid var(--border-color)`},children:[(0,N.jsx)(`strong`,{style:{display:`block`,color:`var(--accent-saffron)`,fontSize:`0.85rem`,marginBottom:`6px`},children:`KĀLA (Time)`}),(0,N.jsxs)(`span`,{style:{fontSize:`0.8rem`,color:`var(--text-secondary)`},children:[`Turn Limit: `,y.turnLimit,` max turns`]})]}),(0,N.jsxs)(`div`,{style:{padding:`16px`,backgroundColor:`rgba(253, 250, 244, 0.5)`,borderRadius:`8px`,border:`1px solid var(--border-color)`},children:[(0,N.jsx)(`strong`,{style:{display:`block`,color:`var(--accent-saffron)`,fontSize:`0.85rem`,marginBottom:`6px`},children:`NIYATI (Space)`}),(0,N.jsx)(`span`,{style:{fontSize:`0.8rem`,color:`var(--text-secondary)`},children:`Directory Lock: target repo only`})]}),(0,N.jsxs)(`div`,{style:{padding:`16px`,backgroundColor:`rgba(253, 250, 244, 0.5)`,borderRadius:`8px`,border:`1px solid var(--border-color)`},children:[(0,N.jsx)(`strong`,{style:{display:`block`,color:`var(--accent-saffron)`,fontSize:`0.85rem`,marginBottom:`6px`},children:`VIDYĀ (Tools)`}),(0,N.jsxs)(`span`,{style:{fontSize:`0.8rem`,color:`var(--text-secondary)`},children:[`Allowed: [`,y.allowedTools.join(`, `),`]`]})]}),(0,N.jsxs)(`div`,{style:{padding:`16px`,backgroundColor:`rgba(253, 250, 244, 0.5)`,borderRadius:`8px`,border:`1px solid var(--border-color)`},children:[(0,N.jsx)(`strong`,{style:{display:`block`,color:`var(--accent-saffron)`,fontSize:`0.85rem`,marginBottom:`6px`},children:`KALĀ (Power)`}),(0,N.jsxs)(`span`,{style:{fontSize:`0.8rem`,color:`var(--text-secondary)`},children:[`Permission: `,y.permission]})]})]}),(0,N.jsx)(`strong`,{style:{display:`block`,fontSize:`0.85rem`,color:`var(--text-muted)`,textTransform:`uppercase`,marginBottom:`8px`},children:`Compiled Sandbox Configuration Payload:`}),(0,N.jsx)(`pre`,{style:{margin:0,padding:`16px`,backgroundColor:`rgba(32, 17, 3, 0.05)`,border:`1px solid var(--border-color)`,borderRadius:`8px`,fontFamily:`monospace`,fontSize:`0.8rem`,color:`var(--text-primary)`,overflowX:`auto`},children:`{
  "active_intent": "${y.category}",
  "limiting_sheaths": {
    "kala_turn_ceiling": ${y.turnLimit},
    "niyati_workspace_bounds": "/Users/universe/AUM",
    "vidya_allowed_tools": ${JSON.stringify(y.allowedTools)},
    "kala_permission_level": "${y.permission}"
  },
  "sanitized_payload": "${g}"
}`})]})]}):n?(0,N.jsxs)(`div`,{className:`aum-journey-container`,children:[(0,N.jsxs)(`div`,{className:`aum-journey-header`,children:[(0,N.jsx)(`span`,{className:`aum-tag`,children:`Vedic Software Engineering 101`}),(0,N.jsx)(`h1`,{className:`aum-journey-title`,children:`Vedic Engineering Journey`}),(0,N.jsx)(`p`,{className:`aum-journey-subtitle`,children:`An analogical guide mapping classical Vedic metaphysics to compiler runtime safety rules. Explore each step side-by-side to understand *why* AUM is built this way.`})]}),(0,N.jsx)(`div`,{className:`aum-journey-timeline`,children:S.map((e,t)=>(0,N.jsxs)(`button`,{onClick:()=>s(t),className:`aum-timeline-node ${t===o?`active`:``} ${t<o?`completed`:``}`,children:[(0,N.jsx)(`div`,{className:`aum-timeline-dot`,children:e.number}),(0,N.jsx)(`span`,{className:`aum-timeline-label`,children:e.label})]},e.number))}),(0,N.jsx)(`div`,{className:`glass-panel`,style:{padding:`24px`,textAlign:`center`,borderBottom:`2px solid var(--accent-saffron)`},children:(0,N.jsx)(`h2`,{style:{fontFamily:`var(--font-display)`,color:`var(--accent-saffron)`,fontSize:`1.4rem`},children:re.title})}),(0,N.jsxs)(`div`,{className:`aum-journey-card-pair`,children:[(0,N.jsxs)(`div`,{className:`aum-journey-card vedic glass-panel`,children:[(0,N.jsxs)(`div`,{className:`aum-journey-card-header`,children:[(0,N.jsx)(Ft,{size:20,style:{color:`var(--accent-saffron)`}}),(0,N.jsx)(`h3`,{className:`aum-journey-card-title`,children:re.vedicTitle})]}),(0,N.jsx)(`p`,{style:{fontSize:`0.9rem`,color:`var(--text-secondary)`},children:re.vedicDesc}),(0,N.jsxs)(`div`,{style:{marginTop:`12px`},children:[(0,N.jsx)(`h4`,{style:{fontSize:`0.75rem`,fontWeight:`700`,textTransform:`uppercase`,color:`var(--text-muted)`,marginBottom:`8px`},children:`Key Metaphysical Concept Parameters:`}),(0,N.jsx)(`div`,{style:{display:`flex`,flexWrap:`wrap`,gap:`8px`},children:re.vedicKeyTerms.map(e=>(0,N.jsx)(`span`,{className:`aum-journey-term`,children:e},e))})]})]}),(0,N.jsx)(`div`,{className:`aum-journey-connector`,children:(0,N.jsx)(jt,{size:24})}),(0,N.jsxs)(`div`,{className:`aum-journey-card engineering glass-panel`,children:[(0,N.jsxs)(`div`,{className:`aum-journey-card-header`,children:[(0,N.jsx)(Vt,{size:20,style:{color:`var(--accent-blue)`}}),(0,N.jsx)(`h3`,{className:`aum-journey-card-title`,children:re.engTitle})]}),(0,N.jsx)(`p`,{style:{fontSize:`0.9rem`,color:`var(--text-secondary)`},children:re.engDesc}),(0,N.jsxs)(`div`,{style:{backgroundColor:`rgba(253, 250, 244, 0.6)`,padding:`12px`,borderRadius:`8px`,border:`1px dashed var(--border-color)`,fontSize:`0.8rem`,color:`var(--text-secondary)`},children:[(0,N.jsx)(`strong`,{children:`The Engineering "Why":`}),` `,re.engWhy]}),(0,N.jsxs)(`button`,{onClick:()=>ie(re.adrLink),className:`aum-journey-adr-link`,children:[`View Deep Technical ADR Log (`,re.adrLink.substring(0,7).toUpperCase(),`) ➔`]})]})]}),(0,N.jsxs)(`div`,{className:`aum-journey-footer`,children:[(0,N.jsx)(`button`,{disabled:o===0,onClick:()=>s(e=>e-1),className:`aum-journey-btn`,children:`← Previous Step`}),(0,N.jsxs)(`span`,{style:{fontSize:`0.85rem`,fontWeight:`600`,color:`var(--text-muted)`},children:[`Step `,re.number,` of `,S.length]}),o===S.length-1?(0,N.jsx)(`button`,{onClick:()=>{r(!1),t(null)},className:`aum-journey-btn primary`,children:`Return to Dashboard`}):(0,N.jsx)(`button`,{onClick:()=>s(e=>e+1),className:`aum-journey-btn primary`,children:`Next Step →`})]})]}):(0,N.jsxs)(`div`,{style:{maxWidth:`1100px`,margin:`0 auto`,display:`flex`,flexDirection:`column`,gap:`32px`},children:[(0,N.jsxs)(`div`,{className:`aum-banner glass-panel`,children:[(0,N.jsx)(`div`,{className:`aum-banner-glow`}),(0,N.jsxs)(`div`,{style:{position:`relative`,zIndex:2},children:[(0,N.jsx)(`span`,{className:`aum-tag`,children:`Live Framework State`}),(0,N.jsx)(`h1`,{className:`aum-banner-title`,children:`The AUM Vedic Cognitive Framework`}),(0,N.jsx)(`p`,{className:`aum-banner-desc`,children:`A technology-agnostic software architecture organizing AI agent workflows under Mandukya state cycles, Pramāṇa epistemology, and Patanjali's ethical boundaries.`}),(0,N.jsxs)(`div`,{style:{display:`flex`,gap:`12px`,flexWrap:`wrap`,marginTop:`20px`},children:[(0,N.jsxs)(`button`,{onClick:()=>r(!0),style:{display:`flex`,alignItems:`center`,gap:`8px`,padding:`12px 24px`,backgroundColor:`var(--accent-saffron)`,border:`none`,borderRadius:`8px`,color:`#fff`,fontWeight:`700`,fontSize:`0.9rem`,cursor:`pointer`,boxShadow:`0 4px 12px rgba(194, 65, 12, 0.25)`},children:[(0,N.jsx)(zt,{size:16,fill:`white`}),`Start Guided 31-Step Onboarding Journey`]}),(0,N.jsxs)(`a`,{href:`/AUM/vedic_library/`,style:{display:`flex`,alignItems:`center`,gap:`8px`,padding:`12px 24px`,backgroundColor:`transparent`,border:`1px solid var(--accent-gold)`,borderRadius:`8px`,color:`var(--accent-gold)`,fontWeight:`700`,fontSize:`0.9rem`,textDecoration:`none`,cursor:`pointer`},children:[(0,N.jsx)(Ft,{size:16}),`Launch Interactive Vedic Library`]})]})]})]}),(0,N.jsxs)(`div`,{className:`aum-stats-grid`,children:[(0,N.jsxs)(`div`,{className:`aum-stat-card glass-panel`,children:[(0,N.jsx)(`div`,{className:`aum-stat-icon saffron`,children:(0,N.jsx)(Pt,{size:24})}),(0,N.jsxs)(`div`,{children:[(0,N.jsx)(`span`,{className:`aum-stat-label`,children:`Active Decisions`}),(0,N.jsxs)(`h3`,{className:`aum-stat-val`,children:[T.totalAdrs,` ADRs`]})]})]}),(0,N.jsxs)(`div`,{className:`aum-stat-card glass-panel`,children:[(0,N.jsx)(`div`,{className:`aum-stat-icon gold`,children:(0,N.jsx)(Mt,{size:24})}),(0,N.jsxs)(`div`,{children:[(0,N.jsx)(`span`,{className:`aum-stat-label`,children:`Active Reviews`}),(0,N.jsxs)(`h3`,{className:`aum-stat-val`,children:[T.totalArbs,` ARBs`]})]})]}),(0,N.jsxs)(`div`,{className:`aum-stat-card glass-panel`,children:[(0,N.jsx)(`div`,{className:`aum-stat-icon blue`,children:(0,N.jsx)(It,{size:24})}),(0,N.jsxs)(`div`,{children:[(0,N.jsx)(`span`,{className:`aum-stat-label`,children:`Last Synced`}),(0,N.jsx)(`h3`,{className:`aum-stat-val`,children:T.compiledAt})]})]})]}),(0,N.jsxs)(`div`,{className:`glass-panel`,style:{padding:`32px`},children:[(0,N.jsxs)(`div`,{style:{display:`flex`,alignItems:`center`,gap:`12px`,marginBottom:`20px`},children:[(0,N.jsx)(Lt,{size:20,style:{color:`var(--accent-saffron)`}}),(0,N.jsx)(`h3`,{style:{fontFamily:`var(--font-display)`,fontSize:`1.25rem`,fontWeight:600,color:`var(--text-primary)`},children:`Active Cognitive Impressions (Saṃskāras)`})]}),(0,N.jsx)(`p`,{style:{fontSize:`0.85rem`,color:`var(--text-secondary)`,marginBottom:`20px`,lineHeight:1.6},children:"These are persistent memory traces stored in the workspace cache (`.aum/samskaras/`). Developer agents load these impressions at startup to align execution tendencies (*Vāsanās*) and bypass known compiler and environment conflicts."}),(0,N.jsx)(`div`,{style:{display:`flex`,flexDirection:`column`,gap:`16px`},children:(Ut.samskaras||[]).map(e=>(0,N.jsxs)(`div`,{style:{padding:`16px`,backgroundColor:`rgba(253, 250, 244, 0.5)`,border:`1px solid var(--border-color)`,borderRadius:`8px`},children:[(0,N.jsxs)(`div`,{style:{display:`flex`,alignItems:`center`,justifyContent:`space-between`,flexWrap:`wrap`,gap:`8px`,marginBottom:`8px`},children:[(0,N.jsx)(`strong`,{style:{fontSize:`0.9rem`,color:`var(--accent-gold)`},children:e.task_title||e.sankalpa_id}),(0,N.jsx)(`span`,{className:`aum-tag`,style:{margin:0,fontSize:`0.65rem`},children:e.sankalpa_id})]}),(0,N.jsx)(`p`,{style:{fontSize:`0.8rem`,color:`var(--text-secondary)`,marginBottom:`8px`},children:e.summary}),(0,N.jsx)(`ul`,{style:{paddingLeft:`1.2rem`,margin:0},children:(e.critical_learnings||[]).map((e,t)=>(0,N.jsx)(`li`,{style:{fontSize:`0.75rem`,color:`var(--text-secondary)`,marginBottom:`4px`},children:e},t))})]},e.filename))})]}),(0,N.jsxs)(`div`,{className:`glass-panel`,style:{padding:`40px`,backgroundColor:`var(--bg-surface-glass)`},children:[(0,N.jsxs)(`div`,{style:{display:`flex`,alignItems:`center`,gap:`12px`,marginBottom:`24px`,borderBottom:`1px solid var(--border-color)`,paddingBottom:`16px`},children:[(0,N.jsx)(Lt,{size:24,style:{color:`var(--accent-saffron)`}}),(0,N.jsx)(`h2`,{style:{fontFamily:`var(--font-display)`,fontSize:`1.6rem`,fontWeight:700,color:`var(--text-primary)`},children:`Vedic Software Engineering Handbook`})]}),(0,N.jsx)(`p`,{style:{color:`var(--text-secondary)`,fontSize:`0.95rem`,marginBottom:`28px`,lineHeight:1.7},children:`Welcome to AUM. This handbook provides an immediate, systematic crash course mapping classical Sanskrit epistemologies to modern AI agent engineering workflows. Read this guide to understand the core invariants running silently behind your terminal commands.`}),(0,N.jsxs)(`div`,{style:{display:`flex`,flexDirection:`column`,gap:`36px`},children:[(0,N.jsxs)(`div`,{children:[(0,N.jsxs)(`h3`,{style:{fontFamily:`var(--font-display)`,fontSize:`1.2rem`,fontWeight:600,color:`var(--accent-gold)`,marginBottom:`12px`,display:`flex`,alignItems:`center`,gap:`8px`},children:[(0,N.jsx)(`span`,{style:{display:`flex`,width:`24px`,height:`24px`,borderRadius:`50%`,backgroundColor:`rgba(180, 83, 9, 0.08)`,alignItems:`center`,justifyContent:`center`,fontSize:`0.8rem`},children:`1`}),`Cognitive Phases (Māṇḍūkya Upanishad)`]}),(0,N.jsx)(`p`,{style:{color:`var(--text-secondary)`,fontSize:`0.9rem`,marginBottom:`16px`,lineHeight:1.6},children:`AI agent execution loops are structured into four repeating quarters of consciousness to prevent uncontrolled code mutations:`}),(0,N.jsxs)(`div`,{style:{display:`grid`,gridTemplateColumns:`repeat(auto-fit, minmax(220px, 1fr))`,gap:`16px`},children:[(0,N.jsxs)(`div`,{style:{padding:`16px`,backgroundColor:`rgba(253, 250, 244, 0.5)`,borderRadius:`8px`,border:`1px solid var(--border-color)`},children:[(0,N.jsx)(`strong`,{style:{display:`block`,color:`var(--accent-saffron)`,marginBottom:`6px`,fontSize:`0.85rem`},children:`JĀGRAT (Waking)`}),(0,N.jsx)(`span`,{style:{fontSize:`0.8rem`,color:`var(--text-secondary)`},children:`Intake phase parsing user files and terminal specifications at startup.`})]}),(0,N.jsxs)(`div`,{style:{padding:`16px`,backgroundColor:`rgba(253, 250, 244, 0.5)`,borderRadius:`8px`,border:`1px solid var(--border-color)`},children:[(0,N.jsx)(`strong`,{style:{display:`block`,color:`var(--accent-saffron)`,marginBottom:`6px`,fontSize:`0.85rem`},children:`SVAPNA (Dreaming)`}),(0,N.jsx)(`span`,{style:{fontSize:`0.8rem`,color:`var(--text-secondary)`},children:`Blueprinting phase generating abstract architecture review logs.`})]}),(0,N.jsxs)(`div`,{style:{padding:`16px`,backgroundColor:`rgba(253, 250, 244, 0.5)`,borderRadius:`8px`,border:`1px solid var(--border-color)`},children:[(0,N.jsx)(`strong`,{style:{display:`block`,color:`var(--accent-saffron)`,marginBottom:`6px`,fontSize:`0.85rem`},children:`SUṢUPTI (Deep Sleep)`}),(0,N.jsx)(`span`,{style:{fontSize:`0.8rem`,color:`var(--text-secondary)`},children:`Invariant guarding locking Yamas/Niyamas boundaries.`})]}),(0,N.jsxs)(`div`,{style:{padding:`16px`,backgroundColor:`rgba(253, 250, 244, 0.5)`,borderRadius:`8px`,border:`1px solid var(--border-color)`},children:[(0,N.jsx)(`strong`,{style:{display:`block`,color:`var(--accent-saffron)`,marginBottom:`6px`,fontSize:`0.85rem`},children:`TURĪYA (Absolute)`}),(0,N.jsx)(`span`,{style:{fontSize:`0.8rem`,color:`var(--text-secondary)`},children:`The manifest index cataloging the total workspace build tree.`})]})]})]}),(0,N.jsxs)(`div`,{children:[(0,N.jsxs)(`h3`,{style:{fontFamily:`var(--font-display)`,fontSize:`1.2rem`,fontWeight:600,color:`var(--accent-gold)`,marginBottom:`12px`,display:`flex`,alignItems:`center`,gap:`8px`},children:[(0,N.jsx)(`span`,{style:{display:`flex`,width:`24px`,height:`24px`,borderRadius:`50%`,backgroundColor:`rgba(180, 83, 9, 0.08)`,alignItems:`center`,justifyContent:`center`,fontSize:`0.8rem`},children:`2`}),`Verification Framework (Pramāṇa Epistemology)`]}),(0,N.jsx)(`p`,{style:{color:`var(--text-secondary)`,fontSize:`0.9rem`,marginBottom:`16px`,lineHeight:1.6},children:`Every proposed modification is audited using three epistemological validation methods to prove its absolute correctness before staging:`}),(0,N.jsxs)(`div`,{style:{display:`grid`,gridTemplateColumns:`repeat(auto-fit, minmax(280px, 1fr))`,gap:`16px`},children:[(0,N.jsxs)(`div`,{style:{padding:`16px`,backgroundColor:`rgba(253, 250, 244, 0.5)`,borderRadius:`8px`,border:`1px solid var(--border-color)`},children:[(0,N.jsx)(`strong`,{style:{color:`var(--accent-gold)`,fontSize:`0.85rem`},children:`Śabda (Authority)`}),`: Verifying that changes align with strict user instructions and active lock-file parameters.`]}),(0,N.jsxs)(`div`,{style:{padding:`16px`,backgroundColor:`rgba(253, 250, 244, 0.5)`,borderRadius:`8px`,border:`1px solid var(--border-color)`},children:[(0,N.jsx)(`strong`,{style:{color:`var(--accent-gold)`,fontSize:`0.85rem`},children:`Pratyakṣa (Perception)`}),`: Running functional verification tests and compiling code locally to observe raw behaviors.`]}),(0,N.jsxs)(`div`,{style:{padding:`16px`,backgroundColor:`rgba(253, 250, 244, 0.5)`,borderRadius:`8px`,border:`1px solid var(--border-color)`},children:[(0,N.jsx)(`strong`,{style:{color:`var(--accent-gold)`,fontSize:`0.85rem`},children:`Anumāna (Inference)`}),`: Simulating impact analysis of git diff changes on related library references.`]})]})]}),(0,N.jsxs)(`div`,{children:[(0,N.jsxs)(`h3`,{style:{fontFamily:`var(--font-display)`,fontSize:`1.2rem`,fontWeight:600,color:`var(--accent-gold)`,marginBottom:`12px`,display:`flex`,alignItems:`center`,gap:`8px`},children:[(0,N.jsx)(`span`,{style:{display:`flex`,width:`24px`,height:`24px`,borderRadius:`50%`,backgroundColor:`rgba(180, 83, 9, 0.08)`,alignItems:`center`,justifyContent:`center`,fontSize:`0.8rem`},children:`3`}),`Limiting Security Sheaths (Shaiva Kañcukas)`]}),(0,N.jsx)(`p`,{style:{color:`var(--text-secondary)`,fontSize:`0.9rem`,marginBottom:`16px`,lineHeight:1.6},children:`AI agent execution actions are constrained by five sandboxing parameters:`}),(0,N.jsxs)(`table`,{style:{width:`100%`,borderCollapse:`collapse`,fontSize:`0.85rem`,border:`1px solid var(--border-color)`},children:[(0,N.jsx)(`thead`,{children:(0,N.jsxs)(`tr`,{style:{backgroundColor:`rgba(124, 77, 18, 0.04)`},children:[(0,N.jsx)(`th`,{style:{padding:`10px`,border:`1px solid var(--border-color)`,color:`var(--accent-gold)`},children:`Sheath Parameter`}),(0,N.jsx)(`th`,{style:{padding:`10px`,border:`1px solid var(--border-color)`,color:`var(--accent-gold)`},children:`Vedic Concept`}),(0,N.jsx)(`th`,{style:{padding:`10px`,border:`1px solid var(--border-color)`,color:`var(--accent-gold)`},children:`Software Execution Implementation`})]})}),(0,N.jsxs)(`tbody`,{children:[(0,N.jsxs)(`tr`,{children:[(0,N.jsx)(`td`,{style:{padding:`10px`,border:`1px solid var(--border-color)`,fontWeight:`bold`},children:`Turns Limit`}),(0,N.jsx)(`td`,{style:{padding:`10px`,border:`1px solid var(--border-color)`},children:`Kāla (Time)`}),(0,N.jsx)(`td`,{style:{padding:`10px`,border:`1px solid var(--border-color)`,color:`var(--text-secondary)`},children:`Enforces turn cycles limits to block execution loops.`})]}),(0,N.jsxs)(`tr`,{style:{backgroundColor:`rgba(253, 250, 244, 0.3)`},children:[(0,N.jsx)(`td`,{style:{padding:`10px`,border:`1px solid var(--border-color)`,fontWeight:`bold`},children:`Directory Limit`}),(0,N.jsx)(`td`,{style:{padding:`10px`,border:`1px solid var(--border-color)`},children:`Niyati (Space)`}),(0,N.jsx)(`td`,{style:{padding:`10px`,border:`1px solid var(--border-color)`,color:`var(--text-secondary)`},children:`Locks files edits strictly inside the local repository workspace.`})]}),(0,N.jsxs)(`tr`,{children:[(0,N.jsx)(`td`,{style:{padding:`10px`,border:`1px solid var(--border-color)`,fontWeight:`bold`},children:`Scope Limit`}),(0,N.jsx)(`td`,{style:{padding:`10px`,border:`1px solid var(--border-color)`},children:`Rāga (Attachment)`}),(0,N.jsx)(`td`,{style:{padding:`10px`,border:`1px solid var(--border-color)`,color:`var(--text-secondary)`},children:`Restricts focus to tasks listed in the active focus lock file.`})]}),(0,N.jsxs)(`tr`,{style:{backgroundColor:`rgba(253, 250, 244, 0.3)`},children:[(0,N.jsx)(`td`,{style:{padding:`10px`,border:`1px solid var(--border-color)`,fontWeight:`bold`},children:`Tool Limits`}),(0,N.jsx)(`td`,{style:{padding:`10px`,border:`1px solid var(--border-color)`},children:`Kalā / Vidyā (Ability)`}),(0,N.jsx)(`td`,{style:{padding:`10px`,border:`1px solid var(--border-color)`,color:`var(--text-secondary)`},children:`Blocks terminal package installs or external network downloads.`})]})]})]})]})]})]})]})]})]})]})}(0,v.createRoot)(document.getElementById(`root`)).render((0,N.jsx)(_.StrictMode,{children:(0,N.jsx)(Gt,{})}));