...
| │   └── **[decisions/](file:///Users/universe/AUM/.aum/architecture/decisions/)** | *Suṣupti* | Master Architecture Decision Record (ADR) logs (ADR-001 to ADR-018). |
...
`}],compiledAt:`2026-07-14T01:52:19.878Z`},Ut=o((e=>{var t=Symbol.for(`react.transitional.element`);function n(e,n,r){var i=null;if(r!==void 0&&(i=``+r),n.key!==void 0&&(i=``+n.key),`key`in n)for(var a in r={},n)a!==`key`&&(r[a]=n[a]);else r=n;return n=r.ref,{$$typeof:t,type:e,key:i,ref:n===void 0?null:n,props:r}}e.jsx=n,e.jsxs=n})),N=o(((e,t)=>{t.exports=Ut()}))();j.setOptions({gfm:!0,breaks:!0,headerIds:!1,mangle:!1});function Wt(){let[e,t]=(0,_.useState)(null),[n,r]=(0,_.useState)(!1),[i,a]=(0,_.useState)(0),[o,s]=(0,_.useState)(``),[c,l]=(0,_.useState)(!1),u=(0,_.useMemo)(()=>[{number:1,label:`Build Lifecycle`,title:`Sāṅkhya Evolution ➔ Build/Compilation Lifecycle`,vedicTitle:`Vedic Philosophy: Sāṅkhya Material Evolution`,vedicDesc:`In Sāṅkhya philosophy, physical reality (Bhūtas) is not static. It evolves systematically from unmanifest root nature (Prakṛti) through cosmic intellect (Buddhi), self-identity (Ahaṅkāra), and the senses (Indriyas) into physical matter.`,vedicKeyTerms:[`Prakṛti (Root Nature)`,`Buddhi (Syntax Check)`,`Ahaṅkāra (Linking)`,`Bhūtas (Compiled Output)`],engTitle:`Software Analogy: Compiling and Linking`,engDesc:`AUM compiles source files in the same order. Raw uncompiled code (Prakṛti) undergoes syntactic AST analysis (Buddhi), generates object linking namespaces (Ahaṅkāra), and finally produces compiled outputs (Bhūtas).`,engWhy:`This formalizes the pipeline states of our build, ensuring that modifications flow sequentially from source to distribution without state pollution.`,adrLink:`adr_011_sankhye_evolution.md`},{number:2,label:`Sandboxes`,title:`Shaiva Kañcukas ➔ Execution Sandboxes`,vedicTitle:`Vedic Philosophy: The Five Limiting Sheaths`,vedicDesc:`In Shaivism, the infinite power of consciousness (Shiva) is limited by sheaths (Kañcukas) to allow individual agency: time (Kāla), space (Niyati), desire (Rāga), knowledge (Vidyā), and power (Kalā).`,vedicKeyTerms:[`Kāla (Turns Limit)`,`Niyati (Directory Bounds)`,`Rāga (Saṅkalpa Focus)`,`Vidyā/Kalā (Tool Security)`],engTitle:`Software Analogy: Secure Runtime Sandboxing`,engDesc:`AI agents operate with specific runtime limits: Turn limits (Kāla) prevent loops, Workspace restrictions (Niyati) protect local files, Active Saṅkalpa scopes (Rāga) focus edits, and tool blocks (Kalā) limit networking.`,engWhy:`This establishes absolute execution boundaries, preventing AI agents from executing dangerous terminal commands or writing outside the workspace.`,adrLink:`adr_012_shaiva_kancukas.md`},{number:3,label:`Refactoring`,title:`Advaita Vedānta ➔ Code Refactoring & Negation`,vedicTitle:`Vedic Philosophy: Negation (Apavāda / Neti Neti)`,vedicDesc:`Advaita Vedānta uses negation (Apavāda - 'Neti Neti' or 'not this, not this') to strip away illusions and superimpositions (Adhyāsa) to realize ultimate unity (Brahman).`,vedicKeyTerms:[`Adhyāsa (Bloat Superimposition)`,`Apavāda (Negation/Neti-Neti)`,`Brahman (Single Source of Truth)`],engTitle:`Software Analogy: Code De-duplication`,engDesc:`Boilerplate and duplicate files (Adhyāsa) are systematically negated and removed (Apavāda) during build cleaning, consolidating codebases into a single, unified source of truth (Brahman).`,engWhy:`This ensures the codebase stays extremely lean, preventing bloated copy-paste boilerplate from drifting the logic.`,adrLink:`adr_014_advaita_refactoring.md`},{number:4,label:`Config Overrides`,title:`Mīmāṃsā Hermeneutics ➔ Overrides Hierarchy`,vedicTitle:`Vedic Philosophy: Jaimini's Text Analysis Rules`,vedicDesc:`Mīmāṃsā defines a strict hierarchy to interpret and resolve overlapping or conflicting scriptural commands: Direct Text (Śruti) overrides Inference (Liṅga) overrides Sentence Context (Vākya) overrides Section Context (Prakaraṇa).`,vedicKeyTerms:[`Śruti (Direct Configuration)`,`Liṅga (Inferred/Linter Hint)`,`Vākya (Module Scope)`,`Prakaraṇa (Global Rules)`],engTitle:`Software Analogy: Config Hierarchy resolution`,engDesc:`AUM resolves configuration overrides in the same order. Direct settings (Śruti) override linter diagnostic suggestions (Liṅga) which override local module settings (Vākya) which override global rules.`,engWhy:`This eliminates configuration ambiguity when different rule sets overlap, resolving them programmatically without human intervention.`,adrLink:`adr_009_mimamsa_hermeneutics.md`},{number:5,label:`Event Streams`,title:`Spanda Pulsation ➔ Reactive Event Streams`,vedicTitle:`Vedic Philosophy: Spanda (Dynamic Pulse)`,vedicDesc:`Spanda philosophy describes the universe as a dynamic, vibrating pulse. It manifests through opening (Unmeṣa / creation) and closing (Nimeṣa / withdrawal) phases, maintaining cosmic balance.`,vedicKeyTerms:[`Unmeṣa (Event Emission)`,`Nimeṣa (Subscription Cleanup)`,`Spanda-Sandhi (Debounce/Interval)`],engTitle:`Software Analogy: Event-Driven WebSockets`,engDesc:`Reactive streams operate via opening and closing pulses. Events are emitted during Unmeṣa, event listeners and WebSocket subscriptions are cleared during Nimeṣa, and stream intervals are throttled in Spanda-Sandhi.`,engWhy:`This prevents memory leaks in WebSocket and event connections, ensuring that every opened channel is systematically closed.`,adrLink:`adr_013_spanda_reactive.md`},{number:6,label:`Type Safety`,title:`Navya-Nyāya Logic ➔ Strict Typing (AST)`,vedicTitle:`Vedic Philosophy: Symbolic Category Logic`,vedicDesc:`Navya-Nyāya provides a formal symbolic language to describe properties and relations without ambiguity. Every statement defines a subject (Dharmin), its qualifiers, and relation limiters (Avacchedaka).`,vedicKeyTerms:[`Dharmin (Type Signature)`,`Avacchedaka (Type Limiter)`,`Samavāya (Subclass Relation)`],engTitle:`Software Analogy: AST Invariant Boundaries`,engDesc:`AUM enforces strict type safety during AST transformations. Every parameter must define a type (Dharmin), generics must use constraints/limiters (Avacchedaka), and class inheritances must map strictly (Samavāya).`,engWhy:`This prevents type coercion and runtime crashes by validating structural specifications before execution.`,adrLink:`adr_015_navya_nyaya_ast.md`},{number:7,label:`Code Reviews`,title:`Vāda-Vidhī Debate ➔ Branch Code Reviews`,vedicTitle:`Vedic Philosophy: Rules of Logical Debate`,vedicDesc:`Vāda-Vidhī structures truth-seeking debate (Vāda). It defines the parts of a valid proposition (Pratijñā), logical fallacies (Hētvābhāsa), and grounds under which an argument is declared defeated (Nigrahasthāna).`,vedicKeyTerms:[`Pratijñā (PR Intent)`,`Hetu (Git Diff/Evidence)`,`Hētvābhāsa (Syntax Fallacy)`,`Nigrahasthāna (Build Block)`],engTitle:`Software Analogy: PR Verification & Merges`,engDesc:`Pull requests are audited as logical debates. The branch declares a proposition (Pratijñā), the git diff provides evidence (Hetu), code issues are flagged as fallacies (Hētvābhāsa), and build errors trigger defeat (Nigrahasthāna).`,engWhy:`This guarantees master branch stability by programmatically blocking PRs that fail basic compilation or type checks.`,adrLink:`adr_016_vada_vidhi_reviews.md`}],[]),d=(0,_.useMemo)(()=>[{id:`manifest`,name:`Turīya (Manifest)`,icon:It,items:M.manifest?[M.manifest]:[]},{id:`instructions`,name:`Suṣupti (Manuals)`,icon:Vt,items:M.instructions?[M.instructions]:[]},{id:`adrs`,name:`Suṣupti (Decisions)`,icon:Ft,items:M.adrs||[]},{id:`arbs`,name:`Svapna (Reviews)`,icon:Nt,items:M.arbs||[]}],[]),f=(0,_.useMemo)(()=>{if(!o.trim())return d;let e=o.toLowerCase();return d.map(t=>{let n=t.items.filter(t=>{let n=t.attributes?.title?.toLowerCase().includes(e)||!1,r=t.body?.toLowerCase().includes(e)||!1,i=t.filename?.toLowerCase().includes(e)||!1;return n||r||i});return{...t,items:n}}).filter(e=>e.items.length>0)},[d,o]),p=e=>{t(e),r(!1),l(!1),window.scrollTo({top:0,behavior:`smooth`})},m=(0,_.useMemo)(()=>{if(!e)return null;let t=(e.attributes?.title?`# ${e.attributes.title}\n\n`:``)+e.body;return{__html:j.parse(t)}},[e]),h=(0,_.useMemo)(()=>({totalAdrs:M.adrs?.length||0,totalArbs:M.arbs?.length||0,compiledAt:M.compiledAt?new Date(M.compiledAt).toLocaleDateString():`N/A`}),[]),g=u[i],v=e=>{let t=[...M.manifest?[M.manifest]:[],...M.instructions?[M.instructions]:[],...M.adrs||[],...M.arbs||[]].find(t=>t.filename===e);t&&p(t)};return(0,N.jsxs)(`div`,{className:`aum-app`,children:[(0,N.jsxs)(`aside`,{className:`aum-sidebar ${c?`open`:``}`,children:[(0,N.jsxs)(`div`,{className:`aum-sidebar-header`,children:[(0,N.jsxs)(`div`,{className:`aum-brand`,children:[(0,N.jsx)(`div`,{className:`aum-logo`,children:`ॐ`}),(0,N.jsxs)(`div`,{children:[(0,N.jsx)(`h2`,{className:`aum-brand-title`,children:`AUM Engine`}),(0,N.jsx)(`span`,{className:`aum-brand-sub`,children:`Vaikharī Portal`})]})]}),(0,N.jsx)(`button`,{onClick:()=>l(!1),style:{background:`none`,border:`none`,color:`#94a3b8`,cursor:`pointer`,display:`flex`,alignItems:`center`},className:`lg-hidden-btn`,children:(0,N.jsx)(Ht,{size:20})})]}),(0,N.jsxs)(`div`,{className:`aum-search-container`,children:[(0,N.jsx)(Bt,{className:`aum-search-icon`,size:16}),(0,N.jsx)(`input`,{type:`text`,placeholder:`Search documentation...`,value:o,onChange:e=>s(e.target.value),className:`aum-search-input`})]}),(0,N.jsxs)(`button`,{onClick:()=>{r(!1),t(null),l(!1)},className:`aum-dashboard-btn ${!e&&!n?`active`:``}`,style:{marginBottom:`10px`},children:[(0,N.jsx)(jt,{size:18}),(0,N.jsx)(`span`,{children:`Cognitive Dashboard`})]}),(0,N.jsxs)(`button`,{onClick:()=>{r(!0),t(null),l(!1)},className:`aum-dashboard-btn ${n?`active`:``}`,style:{marginBottom:`24px`},children:[(0,N.jsx)(It,{size:18}),(0,N.jsx)(`span`,{children:`Vedic Engineering Journey`})]}),(0,N.jsx)(`nav`,{className:`aum-nav`,children:f.map(t=>(0,N.jsxs)(`div`,{className:`aum-nav-section`,children:[(0,N.jsxs)(`div`,{className:`aum-nav-section-header`,children:[(0,N.jsx)(t.icon,{size:14,style:{color:`#fbbf24`}}),(0,N.jsx)(`span`,{className:`aum-nav-section-title`,children:t.name})]}),(0,N.jsx)(`ul`,{className:`aum-nav-list`,children:t.items.map(t=>{let n=t.attributes?.title||t.filename;return(0,N.jsx)(`li`,{children:(0,N.jsxs)(`button`,{onClick:()=>p(t),className:`aum-nav-btn ${e?.filename===t.filename?`active`:``}`,children:[(0,N.jsx)(`span`,{children:n}),(0,N.jsx)(Pt,{className:`aum-nav-chevron`,size:12})]})},t.filename)})})]},t.id))})]}),(0,N.jsxs)(`div`,{className:`aum-main-content`,children:[(0,N.jsxs)(`header`,{className:`aum-mobile-header`,children:[(0,N.jsxs)(`div`,{className:`aum-brand`,children:[(0,N.jsx)(`div`,{className:`aum-logo`,children:`ॐ`}),(0,N.jsx)(`h1`,{className:`aum-brand-title`,children:`AUM Engine`})]}),(0,N.jsx)(`button`,{onClick:()=>l(!0),style:{background:`none`,border:`none`,color:`#f8fafc`,cursor:`pointer`},children:(0,N.jsx)(Rt,{size:24})})]}),(0,N.jsx)(`main`,{className:`aum-main-viewport`,children:e?(0,N.jsxs)(`div`,{className:`aum-article-view`,children:[(0,N.jsx)(`button`,{onClick:()=>p(null),className:`aum-back-btn`,children:`← Back to Dashboard`}),(0,N.jsxs)(`article`,{className:`aum-article-card glass-panel`,children:[e.attributes&&(0,N.jsxs)(`div`,{className:`aum-article-meta`,children:[e.attributes.phase&&(0,N.jsxs)(`span`,{className:`aum-meta-tag`,children:[`📁 `,e.attributes.phase]}),e.attributes.vedic_state&&(0,N.jsxs)(`span`,{className:`aum-meta-tag`,children:[`👁️ State: `,e.attributes.vedic_state]}),e.attributes.type&&(0,N.jsxs)(`span`,{className:`aum-meta-tag`,children:[`🛡️ `,e.attributes.type]})]}),(0,N.jsx)(`div`,{className:`markdown-body`,dangerouslySetInnerHTML:m})]})]}):n?(0,N.jsxs)(`div`,{className:`aum-journey-container`,children:[(0,N.jsxs)(`div`,{className:`aum-journey-header`,children:[(0,N.jsx)(`span`,{className:`aum-tag`,children:`Vedic Software Engineering 101`}),(0,N.jsx)(`h1`,{className:`aum-journey-title`,children:`Vedic Engineering Journey`}),(0,N.jsx)(`p`,{className:`aum-journey-subtitle`,children:`An analogical guide mapping classical Vedic metaphysics to compiler runtime safety rules. Explore each step side-by-side to understand *why* AUM is built this way.`})]}),(0,N.jsx)(`div`,{className:`aum-journey-timeline`,children:u.map((e,t)=>(0,N.jsxs)(`button`,{onClick:()=>a(t),className:`aum-timeline-node ${t===i?`active`:``} ${t<i?`completed`:``}`,children:[(0,N.jsx)(`div`,{className:`aum-timeline-dot`,children:e.number}),(0,N.jsx)(`span`,{className:`aum-timeline-label`,children:e.label})]},e.number))}),(0,N.jsx)(`div`,{className:`glass-panel`,style:{padding:`24px`,textAlign:`center`,borderBottom:`2px solid var(--accent-saffron)`},children:(0,N.jsx)(`h2`,{style:{fontFamily:`var(--font-display)`,color:`var(--accent-saffron)`,fontSize:`1.4rem`},children:g.title})}),(0,N.jsxs)(`div`,{className:`aum-journey-card-pair`,children:[(0,N.jsxs)(`div`,{className:`aum-journey-card vedic glass-panel`,children:[(0,N.jsxs)(`div`,{className:`aum-journey-card-header`,children:[(0,N.jsx)(It,{size:20,style:{color:`var(--accent-saffron)`}}),(0,N.jsx)(`h3`,{className:`aum-journey-card-title`,children:g.vedicTitle})]}),(0,N.jsx)(`p`,{style:{fontSize:`0.9rem`,color:`var(--text-secondary)`},children:g.vedicDesc}),(0,N.jsxs)(`div`,{style:{marginTop:`12px`},children:[(0,N.jsx)(`h4`,{style:{fontSize:`0.75rem`,fontWeight:`700`,textTransform:`uppercase`,color:`var(--text-muted)`,marginBottom:`8px`},children:`Key Metaphysical Concept Parameters:`}),(0,N.jsx)(`div`,{style:{display:`flex`,flexWrap:`wrap`,gap:`8px`},children:g.vedicKeyTerms.map(e=>(0,N.jsx)(`span`,{className:`aum-journey-term`,children:e},e))})]})]}),(0,N.jsx)(`div`,{className:`aum-journey-connector`,children:(0,N.jsx)(Mt,{size:24})}),(0,N.jsxs)(`div`,{className:`aum-journey-card engineering glass-panel`,children:[(0,N.jsxs)(`div`,{className:`aum-journey-card-header`,children:[(0,N.jsx)(Vt,{size:20,style:{color:`var(--accent-blue)`}}),(0,N.jsx)(`h3`,{className:`aum-journey-card-title`,children:g.engTitle})]}),(0,N.jsx)(`p`,{style:{fontSize:`0.9rem`,color:`var(--text-secondary)`},children:g.engDesc}),(0,N.jsxs)(`div`,{style:{backgroundColor:`rgba(253, 250, 244, 0.6)`,padding:`12px`,borderRadius:`8px`,border:`1px dashed var(--border-color)`,fontSize:`0.8rem`,color:`var(--text-secondary)`},children:[(0,N.jsx)(`strong`,{children:`The Engineering "Why":`}),` `,g.engWhy]}),(0,N.jsxs)(`button`,{onClick:()=>v(g.adrLink),className:`aum-journey-adr-link`,children:[`View Deep Technical ADR Log (`,g.adrLink.substring(0,7).toUpperCase(),`) ➔`]})]})]}),(0,N.jsxs)(`div`,{className:`aum-journey-footer`,children:[(0,N.jsx)(`button`,{disabled:i===0,onClick:()=>a(e=>e-1),className:`aum-journey-btn`,children:`← Previous Step`}),(0,N.jsxs)(`span`,{style:{fontSize:`0.85rem`,fontWeight:`600`,color:`var(--text-muted)`},children:[`Step `,g.number,` of `,u.length]}),i===u.length-1?(0,N.jsx)(`button`,{onClick:()=>{r(!1),t(null)},className:`aum-journey-btn primary`,children:`Return to Dashboard`}):(0,N.jsx)(`button`,{onClick:()=>a(e=>e+1),className:`aum-journey-btn primary`,children:`Next Step →`})]})]}):(0,N.jsxs)(`div`,{style:{maxWidth:`1100px`,margin:`0 auto`,display:`flex`,flexDirection:`column`,gap:`32px`},children:[(0,N.jsxs)(`div`,{className:`aum-banner glass-panel`,children:[(0,N.jsx)(`div`,{className:`aum-banner-glow`}),(0,N.jsxs)(`div`,{style:{position:`relative`,zIndex:2},children:[(0,N.jsx)(`span`,{className:`aum-tag`,children:`Live Framework State`}),(0,N.jsx)(`h1`,{className:`aum-banner-title`,children:`The AUM Vedic Cognitive Framework`}),(0,N.jsx)(`p`,{className:`aum-banner-desc`,children:`A technology-agnostic software architecture organizing AI agent workflows under Mandukya state cycles, Pramāṇa epistemology, and Patanjali's ethical boundaries.`}),(0,N.jsxs)(`button`,{onClick:()=>r(!0),style:{marginTop:`20px`,display:`flex`,alignItems:`center`,gap:`8px`,padding:`12px 24px`,backgroundColor:`var(--accent-saffron)`,border:`none`,borderRadius:`8px`,color:`#fff`,fontWeight:`700`,fontSize:`0.9rem`,cursor:`pointer`,boxShadow:`0 4px 12px rgba(194, 65, 12, 0.25)`},children:[(0,N.jsx)(zt,{size:16,fill:`white`}),`Start Guided Vedic Engineering Journey`]})]})]}),(0,N.jsxs)(`div`,{className:`aum-stats-grid`,children:[(0,N.jsxs)(`div`,{className:`aum-stat-card glass-panel`,children:[(0,N.jsx)(`div`,{className:`aum-stat-icon saffron`,children:(0,N.jsx)(Ft,{size:24})}),(0,N.jsxs)(`div`,{children:[(0,N.jsx)(`span`,{className:`aum-stat-label`,children:`Active Decisions`}),(0,N.jsxs)(`h3`,{className:`aum-stat-val`,children:[h.totalAdrs,` ADRs`]})]})]}),(0,N.jsxs)(`div`,{className:`aum-stat-card glass-panel`,children:[(0,N.jsx)(`div`,{className:`aum-stat-icon gold`,children:(0,N.jsx)(Nt,{size:24})}),(0,N.jsxs)(`div`,{children:[(0,N.jsx)(`span`,{className:`aum-stat-label`,children:`Active Reviews`}),(0,N.jsxs)(`h3`,{className:`aum-stat-val`,children:[h.totalArbs,` ARBs`]})]})]}),(0,N.jsxs)(`div`,{className:`aum-stat-card glass-panel`,children:[(0,N.jsx)(`div`,{className:`aum-stat-icon blue`,children:(0,N.jsx)(Lt,{size:24})}),(0,N.jsxs)(`div`,{children:[(0,N.jsx)(`span`,{className:`aum-stat-label`,children:`Last Synced`}),(0,N.jsx)(`h3`,{className:`aum-stat-val`,children:h.compiledAt})]})]})]}),(0,N.jsxs)(`div`,{className:`aum-info-grid`,children:[(0,N.jsxs)(`div`,{className:`aum-info-card glass-panel`,children:[(0,N.jsxs)(`div`,{className:`aum-info-header`,children:[(0,N.jsx)(`div`,{className:`aum-info-bar`}),(0,N.jsx)(`h2`,{className:`aum-info-title`,children:`Quarters of Consciousness (Māṇḍūkya)`})]}),(0,N.jsxs)(`div`,{className:`aum-info-list`,children:[(0,N.jsxs)(`div`,{className:`aum-info-item`,children:[(0,N.jsx)(`h4`,{className:`aum-info-item-title`,children:`1. Jāgrat (Waking State) — Intake`}),(0,N.jsx)(`p`,{className:`aum-info-item-desc`,children:`Gathers context, processes initial user requirements, and defines task inputs.`})]}),(0,N.jsxs)(`div`,{className:`aum-info-item`,children:[(0,N.jsx)(`h4`,{className:`aum-info-item-title`,children:`2. Svapna (Dreaming State) — Blueprint`}),(0,N.jsx)(`p`,{className:`aum-info-item-desc`,children:`Abstract cognitive planning, architecture design logs, and workflow blueprints.`})]}),(0,N.jsxs)(`div`,{className:`aum-info-item`,children:[(0,N.jsx)(`h4`,{className:`aum-info-item-title`,children:`3. Suṣupti (Deep Sleep) — Invariant Bounds`}),(0,N.jsx)(`p`,{className:`aum-info-item-desc`,children:`Frozen system configurations, ethics rules (Yamas/Niyamas), and safety boundaries.`})]}),(0,N.jsxs)(`div`,{className:`aum-info-item`,children:[(0,N.jsx)(`h4`,{className:`aum-info-item-title`,children:`4. Turīya (Absolute Consciousness) — Manifest Index`}),(0,N.jsx)(`p`,{className:`aum-info-item-desc`,children:`The Mūla Sphoṭa global manifest indexing the entire repository state.`})]})]})]}),(0,N.jsxs)(`div`,{className:`aum-info-card glass-panel`,children:[(0,N.jsxs)(`div`,{className:`aum-info-header`,children:[(0,N.jsx)(`div`,{className:`aum-info-bar`}),(0,N.jsx)(`h2`,{className:`aum-info-title`,children:`Limiting Sheaths of Agency (Shaiva Kañcukas)`})]}),(0,N.jsxs)(`div`,{className:`aum-info-list`,children:[(0,N.jsxs)(`div`,{className:`aum-info-item`,children:[(0,N.jsx)(`h4`,{className:`aum-info-item-title`,children:`Kāla (Time Bounds)`}),(0,N.jsx)(`p`,{className:`aum-info-item-desc`,children:`Limits maximum turn step counts to prevent infinite loops during diagnostic executions.`})]}),(0,N.jsxs)(`div`,{className:`aum-info-item`,children:[(0,N.jsx)(`h4`,{className:`aum-info-item-title`,children:`Niyati (Space Bounds)`}),(0,N.jsx)(`p`,{className:`aum-info-item-desc`,children:`Limits file system actions strictly to the workspace directory to prevent sandbox leakage.`})]}),(0,N.jsxs)(`div`,{className:`aum-info-item`,children:[(0,N.jsx)(`h4`,{className:`aum-info-item-title`,children:`Rāga (Scope Limits)`}),(0,N.jsx)(`p`,{className:`aum-info-item-desc`,children:`Restricts modifications to items explicitly mapped out in the active Saṅkalpa log.`})]}),(0,N.jsxs)(`div`,{className:`aum-info-item`,children:[(0,N.jsx)(`h4`,{className:`aum-info-item-title`,children:`Kalā / Vidyā (Tool Safety)`}),(0,N.jsx)(`p`,{className:`aum-info-item-desc`,children:`Blocks arbitrary terminal network downloads (npm/pip) without explicit developer confirmation.`})]})]})]})]})]})})]})]})}(0,v.createRoot)(document.getElementById(`root`)).render((0,N.jsx)(_.StrictMode,{children:(0,N.jsx)(Wt,{})}));