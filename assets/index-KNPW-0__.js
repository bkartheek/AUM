...
`}],compiledAt:`2026-07-14T01:13:18.479Z`},Ht=o((e=>{var t=Symbol.for(`react.transitional.element`);function n(e,n,r){var i=null;if(r!==void 0&&(i=``+r),n.key!==void 0&&(i=``+n.key),`key`in n)for(var a in r={},n)a!==`key`&&(r[a]=n[a]);else r=n;return n=r.ref,{$$typeof:t,type:e,key:i,ref:n===void 0?null:n,props:r}}e.jsx=n,e.jsxs=n})),M=o(((e,t)=>{t.exports=Ht()}))();j.setOptions({gfm:!0,breaks:!0,headerIds:!1,mangle:!1});function Ut(){let[e,t]=(0,_.useState)(null),[n,r]=(0,_.useState)(``),[i,a]=(0,_.useState)(!1),o=(0,_.useMemo)(()=>[{id:`manifest`,name:`Turīya (Manifest)`,icon:Ft,items:Vt.manifest?[Vt.manifest]:[]},{id:`instructions`,name:`Suṣupti (Manuals)`,icon:zt,items:Vt.instructions?[Vt.instructions]:[]},{id:`adrs`,name:`Suṣupti (Decisions)`,icon:Pt,items:Vt.adrs||[]},{id:`arbs`,name:`Svapna (Reviews)`,icon:Mt,items:Vt.arbs||[]}],[]),s=(0,_.useMemo)(()=>{if(!n.trim())return o;let e=n.toLowerCase();return o.map(t=>{let n=t.items.filter(t=>{let n=t.attributes?.title?.toLowerCase().includes(e)||!1,r=t.body?.toLowerCase().includes(e)||!1,i=t.filename?.toLowerCase().includes(e)||!1;return n||r||i});return{...t,items:n}}).filter(e=>e.items.length>0)},[o,n]),c=e=>{t(e),a(!1),window.scrollTo({top:0,behavior:`smooth`})},l=(0,_.useMemo)(()=>{if(!e)return null;let t=(e.attributes?.title?`# ${e.attributes.title}\n\n`:``)+e.body;return{__html:j.parse(t)}},[e]),u=(0,_.useMemo)(()=>({totalAdrs:Vt.adrs?.length||0,totalArbs:Vt.arbs?.length||0,compiledAt:Vt.compiledAt?new Date(Vt.compiledAt).toLocaleDateString():`N/A`}),[]);return(0,M.jsxs)(`div`,{className:`min-h-screen flex bg-slate-950 text-slate-100 font-sans antialiased`,children:[(0,M.jsxs)(`aside`,{className:`
      ...
      `,children:[(0,M.jsxs)(`div`,{className:`flex items-center justify-between mb-8`,children:[(0,M.jsxs)(`div`,{className:`flex items-center gap-3`,children:[(0,M.jsx)(`div`,{className:`w-10 h-10 rounded-xl bg-gradient-to-tr from-orange-600 to-amber-500 flex items-center justify-center font-bold text-lg text-white shadow-lg shadow-orange-950/30`,children:`ॐ`}),(0,M.jsxs)(`div`,{children:[(0,M.jsx)(`h2`,{className:`font-display font-bold text-lg tracking-tight text-white`,children:`AUM Engine`}),(0,M.jsx)(`span`,{className:`text-xs font-semibold text-amber-500 tracking-wider uppercase`,children:`Vaikharī Portal`})]})]}),(0,M.jsx)(`button`,{onClick:()=>a(!1),className:`p-2 text-slate-400 hover:text-white lg:hidden`,children:(0,M.jsx)(Bt,{size:20})})]}),(0,M.jsxs)(`div`,{className:`relative mb-6`,children:[(0,M.jsx)(Rt,{className:`absolute left-3 top-1/2 transform -translate-y-1/2 text-slate-400`,size:16}),(0,M.jsx)(`input`,{type:`text`,placeholder:`Search documentation...`,value:n,onChange:e=>r(e.target.value),className:`w-full bg-slate-950 border border-amber-950/20 rounded-lg pl-10 pr-4 py-2 text-sm text-slate-100 placeholder-slate-500 focus:outline-none focus:border-amber-500 transition-colors`})]}),(0,M.jsxs)(`button`,{onClick:()=>c(null),className:`
            w-full flex items-center gap-3 px-4 py-3 rounded-lg mb-6 text-sm font-semibold transition-colors
            ${e?`text-slate-400 hover:text-white hover:bg-slate-800/40`:`bg-gradient-to-r from-orange-950/40 to-amber-950/10 border border-orange-500/20 text-orange-400`}
          `,children:[(0,M.jsx)(jt,{size:18}),(0,M.jsx)(`span`,{children:`Cognitive Dashboard`})]}),(0,M.jsx)(`nav`,{className:`space-y-6 overflow-y-auto max-h-[calc(100vh-280px)] pr-2`,children:s.map(t=>(0,M.jsxs)(`div`,{children:[(0,M.jsxs)(`div`,{className:`flex items-center gap-2 mb-2 px-2`,children:[(0,M.jsx)(t.icon,{className:`text-amber-500/60`,size:16}),(0,M.jsx)(`span`,{className:`text-xs font-bold text-slate-500 uppercase tracking-wider`,children:t.name})]}),(0,M.jsx)(`ul`,{className:`space-y-1`,children:t.items.map(t=>{let n=t.attributes?.title||t.filename;return(0,M.jsx)(`li`,{children:(0,M.jsxs)(`button`,{onClick:()=>c(t),className:`
                          w-full text-left px-3 py-2 rounded-md text-xs transition-colors flex items-center justify-between group
                          ${e?.filename===t.filename?`bg-amber-950/20 text-amber-400 border-l-2 border-amber-500`:`text-slate-400 hover:text-white hover:bg-slate-800/30`}
                        `,children:[(0,M.jsx)(`span`,{className:`truncate pr-2`,children:n}),(0,M.jsx)(Nt,{className:`opacity-0 group-hover:opacity-100 transition-opacity text-amber-500`,size:12})]})},t.filename)})})]},t.id))})]}),(0,M.jsxs)(`div`,{className:`flex-1 flex flex-col min-w-0`,children:[(0,M.jsxs)(`header`,{className:`flex items-center justify-between p-4 bg-slate-900 border-b border-amber-950/20 lg:hidden`,children:[(0,M.jsxs)(`div`,{className:`flex items-center gap-3`,children:[(0,M.jsx)(`div`,{className:`w-8 h-8 rounded-lg bg-orange-600 flex items-center justify-center font-bold text-white`,children:`ॐ`}),(0,M.jsx)(`h1`,{className:`font-display font-bold text-md text-white`,children:`AUM Engine`})]}),(0,M.jsx)(`button`,{onClick:()=>a(!0),className:`p-2 text-slate-400 hover:text-white`,children:(0,M.jsx)(Lt,{size:24})})]}),(0,M.jsx)(`main`,{className:`flex-1 p-6 md:p-12 overflow-y-auto`,children:e?(0,M.jsxs)(`div`,{className:`max-w-4xl mx-auto`,children:[(0,M.jsx)(`button`,{onClick:()=>c(null),className:`text-xs font-semibold text-amber-500 hover:text-amber-400 mb-6 flex items-center gap-1`,children:`← Back to Dashboard`}),(0,M.jsxs)(`article`,{className:`glass-panel p-8 md:p-12`,children:[e.attributes&&(0,M.jsxs)(`div`,{className:`flex flex-wrap gap-3 mb-8 border-b border-amber-950/15 pb-6 text-xs font-medium text-slate-400`,children:[e.attributes.phase&&(0,M.jsxs)(`span`,{className:`px-2.5 py-1 bg-slate-950/60 rounded-full border border-amber-950/10`,children:[`📁 `,e.attributes.phase]}),e.attributes.vedic_state&&(0,M.jsxs)(`span`,{className:`px-2.5 py-1 bg-slate-950/60 rounded-full border border-amber-950/10`,children:[`👁️ State: `,e.attributes.vedic_state]}),e.attributes.type&&(0,M.jsxs)(`span`,{className:`px-2.5 py-1 bg-slate-950/60 rounded-full border border-amber-950/10`,children:[`🛡️ `,e.attributes.type]})]}),(0,M.jsx)(`div`,{className:`markdown-body`,dangerouslySetInnerHTML:l})]})]}):(0,M.jsxs)(`div`,{className:`max-w-6xl mx-auto space-y-8`,children:[(0,M.jsxs)(`div`,{className:`glass-panel p-8 md:p-12 relative overflow-hidden bg-gradient-to-br from-slate-900 to-indigo-950/20`,children:[(0,M.jsxs)(`div`,{className:`relative z-10 max-w-2xl space-y-4`,children:[(0,M.jsx)(`span`,{className:`px-2.5 py-1 bg-orange-600/10 text-orange-400 rounded-full text-xs font-semibold border border-orange-500/20`,children:`Live Framework State`}),(0,M.jsx)(`h1`,{className:`font-display font-bold text-4xl md:text-5xl text-white tracking-tight leading-tight`,children:`The AUM Vedic Cognitive Framework`}),(0,M.jsx)(`p`,{className:`text-slate-400 text-lg`,children:`A technology-agnostic software architecture organizing AI agent workflows under Mandukya state cycles, Pramāṇa epistemology, and Patanjali's ethical boundaries.`})]}),(0,M.jsx)(`div`,{className:`absolute right-0 top-0 w-80 h-80 bg-orange-600/10 rounded-full blur-3xl -z-10`})]}),(0,M.jsxs)(`div`,{className:`grid grid-cols-1 md:grid-cols-3 gap-6`,children:[(0,M.jsxs)(`div`,{className:`glass-panel p-6 flex items-center gap-4`,children:[(0,M.jsx)(`div`,{className:`w-12 h-12 rounded-xl bg-orange-600/10 text-orange-400 flex items-center justify-center`,children:(0,M.jsx)(Pt,{size:24})}),(0,M.jsxs)(`div`,{children:[(0,M.jsx)(`span`,{className:`text-xs font-semibold text-slate-500 uppercase tracking-wider`,children:`Active Decisions`}),(0,M.jsxs)(`h3`,{className:`text-2xl font-bold text-white`,children:[u.totalAdrs,` ADRs`]})]})]}),(0,M.jsxs)(`div`,{className:`glass-panel p-6 flex items-center gap-4`,children:[(0,M.jsx)(`div`,{className:`w-12 h-12 rounded-xl bg-amber-600/10 text-amber-400 flex items-center justify-center`,children:(0,M.jsx)(Mt,{size:24})}),(0,M.jsxs)(`div`,{children:[(0,M.jsx)(`span`,{className:`text-xs font-semibold text-slate-500 uppercase tracking-wider`,children:`Active Reviews`}),(0,M.jsxs)(`h3`,{className:`text-2xl font-bold text-white`,children:[u.totalArbs,` ARBs`]})]})]}),(0,M.jsxs)(`div`,{className:`glass-panel p-6 flex items-center gap-4`,children:[(0,M.jsx)(`div`,{className:`w-12 h-12 rounded-xl bg-blue-600/10 text-blue-400 flex items-center justify-center`,children:(0,M.jsx)(It,{size:24})}),(0,M.jsxs)(`div`,{children:[(0,M.jsx)(`span`,{className:`text-xs font-semibold text-slate-500 uppercase tracking-wider`,children:`Last Synced`}),(0,M.jsx)(`h3`,{className:`text-2xl font-bold text-white`,children:u.compiledAt})]})]})]}),(0,M.jsxs)(`div`,{className:`grid grid-cols-1 lg:grid-cols-2 gap-8`,children:[(0,M.jsxs)(`div`,{className:`glass-panel p-8 space-y-6`,children:[(0,M.jsxs)(`h2`,{className:`font-display font-bold text-xl text-white flex items-center gap-2`,children:[(0,M.jsx)(`span`,{className:`w-2 h-6 bg-orange-600 rounded`}),`Quarters of Consciousness (Māṇḍūkya)`]}),(0,M.jsxs)(`div`,{className:`space-y-4`,children:[(0,M.jsxs)(`div`,{className:`p-4 bg-slate-950/60 rounded-lg border border-amber-950/10`,children:[(0,M.jsx)(`h4`,{className:`text-amber-400 font-display font-semibold text-sm`,children:`1. Jāgrat (Waking State) — Intake`}),(0,M.jsx)(`p`,{className:`text-xs text-slate-400 mt-1`,children:`Gathers context, processes initial user requirements, and defines task inputs.`})]}),(0,M.jsxs)(`div`,{className:`p-4 bg-slate-950/60 rounded-lg border border-amber-950/10`,children:[(0,M.jsx)(`h4`,{className:`text-amber-400 font-display font-semibold text-sm`,children:`2. Svapna (Dreaming State) — Blueprint`}),(0,M.jsx)(`p`,{className:`text-xs text-slate-400 mt-1`,children:`Abstract cognitive planning, architecture design logs, and workflow blueprints.`})]}),(0,M.jsxs)(`div`,{className:`p-4 bg-slate-950/60 rounded-lg border border-amber-950/10`,children:[(0,M.jsx)(`h4`,{className:`text-amber-400 font-display font-semibold text-sm`,children:`3. Suṣupti (Deep Sleep) — Invariant Bounds`}),(0,M.jsx)(`p`,{className:`text-xs text-slate-400 mt-1`,children:`Frozen system configurations, ethics rules (Yamas/Niyamas), and safety boundaries.`})]}),(0,M.jsxs)(`div`,{className:`p-4 bg-slate-950/60 rounded-lg border border-amber-950/10`,children:[(0,M.jsx)(`h4`,{className:`text-amber-400 font-display font-semibold text-sm`,children:`4. Turīya (Absolute Consciousness) — Manifest Index`}),(0,M.jsx)(`p`,{className:`text-xs text-slate-400 mt-1`,children:`The Mūla Sphoṭa global manifest indexing the entire repository state.`})]})]})]}),(0,M.jsxs)(`div`,{className:`glass-panel p-8 space-y-6`,children:[(0,M.jsxs)(`h2`,{className:`font-display font-bold text-xl text-white flex items-center gap-2`,children:[(0,M.jsx)(`span`,{className:`w-2 h-6 bg-orange-600 rounded`}),`Limiting Sheaths of Agency (Shaiva Kañcukas)`]}),(0,M.jsxs)(`div`,{className:`space-y-4`,children:[(0,M.jsxs)(`div`,{className:`p-4 bg-slate-950/60 rounded-lg border border-amber-950/10`,children:[(0,M.jsx)(`h4`,{className:`text-amber-400 font-display font-semibold text-sm`,children:`Kāla (Time Bounds)`}),(0,M.jsx)(`p`,{className:`text-xs text-slate-400 mt-1`,children:`Limits maximum turn step counts to prevent infinite loops during diagnostic executions.`})]}),(0,M.jsxs)(`div`,{className:`p-4 bg-slate-950/60 rounded-lg border border-amber-950/10`,children:[(0,M.jsx)(`h4`,{className:`text-amber-400 font-display font-semibold text-sm`,children:`Niyati (Space Bounds)`}),(0,M.jsx)(`p`,{className:`text-xs text-slate-400 mt-1`,children:`Limits file system actions strictly to the workspace directory to prevent sandbox leakage.`})]}),(0,M.jsxs)(`div`,{className:`p-4 bg-slate-950/60 rounded-lg border border-amber-950/10`,children:[(0,M.jsx)(`h4`,{className:`text-amber-400 font-display font-semibold text-sm`,children:`Rāga (Scope Limits)`}),(0,M.jsx)(`p`,{className:`text-xs text-slate-400 mt-1`,children:`Restricts modifications to items explicitly mapped out in the active Saṅkalpa log.`})]}),(0,M.jsxs)(`div`,{className:`p-4 bg-slate-950/60 rounded-lg border border-amber-950/10`,children:[(0,M.jsx)(`h4`,{className:`text-amber-400 font-display font-semibold text-sm`,children:`Kalā / Vidyā (Tool Safety)`}),(0,M.jsx)(`p`,{className:`text-xs text-slate-400 mt-1`,children:`Blocks arbitrary terminal network downloads (npm/pip) without explicit developer confirmation.`})]})]})]})]})]})})]})]})}(0,v.createRoot)(document.getElementById(`root`)).render((0,M.jsx)(_.StrictMode,{children:(0,M.jsx)(Ut,{})}));