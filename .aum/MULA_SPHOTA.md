...
# Mūla Sphoṭa Global Manifest (V1.12.0)
...
| │   └── **[decisions/](file:///Users/universe/AUM/.aum/architecture/decisions/)** | *Suṣupti* | Master Architecture Decision Record (ADR) logs (ADR-001 to ADR-013). |
