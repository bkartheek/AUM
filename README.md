...
*   **`.aum/`** — Core portable configuration folder containing:
    ...
    *   **`architecture/`** — Master Architecture Review Board logs (ARB-000 through ARB-009):
        ...
        *   **`decisions/`** — Centralized Architecture Decision Record (ADR) logs (ADR-001 through ADR-009).
